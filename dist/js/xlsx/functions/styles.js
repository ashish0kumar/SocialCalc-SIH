...
export function addNumberFormats(numFmts) {
    const numFmtNodes = [];
...
export function addFills(fills) {
    const fillNodes = [];
...
export function addBorders(borders) {
    const borderNodes = [];
...
export function formatBorderAttribute(description) {
    if (!description) {
        return escapeXml ``;
    }
 ...
 */
export function addCellWiseConditionalFormatting(dxfs // cell-wise CF
) {
    var _a;
    const dxfNodes = [];
