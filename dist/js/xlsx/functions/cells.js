...
import { formatDateTime, mdyDateRegexp, parseDateTime, timeRegexp, ymdDateRegexp, } from "../../helpers/dates";
...
export function addFormula(cell) {
...
export function addContent(content, sharedStrings) {
    let value = content;
    const attrs = [];
...
export function adaptFormulaToExcel(formulaText) {
    if (formulaText[0] === "=") {
