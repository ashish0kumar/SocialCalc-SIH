...
export const RELATIONSHIP_NSR = "http://schemas.openxmlformats.org/officeDocument/2006/relationships";
export const HEIGHT_FACTOR = 0.75; // 100px => 75 u
export const WIDTH_FACTOR = 0.1425; // 100px => 14.25 u
export const FIRST_NUMFMT_ID = 164;
export const FORCE_DEFAULT_ARGS_FUNCTIONS = {
