...
export function setFormatter(env, format) {
...
export function setStyle(env, style) {
    env.model.dispatch("SET_FORMATTING", {
        sheetId: env.model.getters.getActiveSheetId(),
        target: env.model.getters.getSelectedZones(),
        style,
...
// Simple actions
//------------------------------------------------------------------------------
export const UNDO_ACTION = (env) => env.model.dispatch("REQUEST_UNDO");
export const REDO_ACTION = (env) => env.model.dispatch("REQUEST_REDO");
export const COPY_ACTION = async (env) => {
...
export const CUT_ACTION = async (env) => {
    env.model.dispatch("CUT", { target: env.model.getters.getSelectedZones() });
    await env.clipboard.writeText(env.model.getters.getClipboardContent());
};
export const PASTE_ACTION = async (env) => {
...
export const PASTE_VALUE_ACTION = (env) => env.model.dispatch("PASTE", {
    target: env.model.getters.getSelectedZones(),
    pasteOption: "onlyValue",
});
export const PASTE_FORMAT_ACTION = (env) => env.model.dispatch("PASTE", {
    target: env.model.getters.getSelectedZones(),
    pasteOption: "onlyFormat",
});
export const DELETE_CONTENT_ACTION = (env) => env.model.dispatch("DELETE_CONTENT", {
    sheetId: env.model.getters.getActiveSheetId(),
    target: env.model.getters.getSelectedZones(),
});
export const SET_FORMULA_VISIBILITY_ACTION = (env) => env.model.dispatch("SET_FORMULA_VISIBILITY", { show: !env.model.getters.shouldShowFormulas() });
export const SET_GRID_LINES_VISIBILITY_ACTION = (env) => {
...
// Grid manipulations
//------------------------------------------------------------------------------
export const DELETE_CONTENT_ROWS_NAME = (env) => {
...
export const DELETE_CONTENT_ROWS_ACTION = (env) => {
    const sheetId = env.model.getters.getActiveSheetId();
...
export const DELETE_CONTENT_COLUMNS_NAME = (env) => {
    if (env.model.getters.getSelectedZones().length > 1) {
...
export const DELETE_CONTENT_COLUMNS_ACTION = (env) => {
    const sheetId = env.model.getters.getActiveSheetId();
...
export const REMOVE_ROWS_NAME = (env) => {
    if (env.model.getters.getSelectedZones().length > 1) {
...
export const REMOVE_ROWS_ACTION = (env) => {
...
export const REMOVE_COLUMNS_NAME = (env) => {
    if (env.model.getters.getSelectedZones().length > 1) {
...
export const REMOVE_COLUMNS_ACTION = (env) => {
...
export const ROW_INSERT_ROWS_BEFORE_NAME = (env) => {
    const number = getRowsNumber(env);
    return number === 1 ? _lt("Insert row above") : _lt("Insert %s rows above", number.toString());
};
export const CELL_INSERT_ROWS_BEFORE_NAME = (env) => {
    const number = getRowsNumber(env);
    if (number === 1) {
...
export const INSERT_ROWS_BEFORE_ACTION = (env) => {
    const activeRows = env.model.getters.getActiveRows();
    let row;
    let quantity;
    if (activeRows.size) {
...
export const MENU_INSERT_ROWS_AFTER_NAME = (env) => {
    const number = getRowsNumber(env);
    if (number === 1) {
...
export const ROW_INSERT_ROWS_AFTER_NAME = (env) => {
    const number = getRowsNumber(env);
    return number === 1 ? _lt("Insert row below") : _lt("Insert %s rows below", number.toString());
};
export const INSERT_ROWS_AFTER_ACTION = (env) => {
    const activeRows = env.model.getters.getActiveRows();
    let row;
    let quantity;
    if (activeRows.size) {
...
export const MENU_INSERT_COLUMNS_BEFORE_NAME = (env) => {
...
export const COLUMN_INSERT_COLUMNS_BEFORE_NAME = (env) => {
    const number = getColumnsNumber(env);
    return number === 1
        ? _lt("Insert column left")
        : _lt("Insert %s columns left", number.toString());
};
export const CELL_INSERT_COLUMNS_BEFORE_NAME = (env) => {
    const number = getColumnsNumber(env);
    if (number === 1) {
...
export const INSERT_COLUMNS_BEFORE_ACTION = (env) => {
    const activeCols = env.model.getters.getActiveCols();
    let column;
    let quantity;
    if (activeCols.size) {
...
export const MENU_INSERT_COLUMNS_AFTER_NAME = (env) => {
    const number = getColumnsNumber(env);
    if (number === 1) {
...
export const COLUMN_INSERT_COLUMNS_AFTER_NAME = (env) => {
    const number = getColumnsNumber(env);
    return number === 1
        ? _lt("Insert column right")
        : _lt("Insert %s columns right", number.toString());
};
export const INSERT_COLUMNS_AFTER_ACTION = (env) => {
    const activeCols = env.model.getters.getActiveCols();
    let column;
    let quantity;
    if (activeCols.size) {
...
export const HIDE_COLUMNS_NAME = (env) => {
...
export const HIDE_COLUMNS_ACTION = (env) => {
...
export const UNHIDE_ALL_COLUMNS_ACTION = (env) => {
...
export const UNHIDE_COLUMNS_ACTION = (env) => {
    const columns = env.model.getters.getElementsFromSelection("COL");
    env.model.dispatch("UNHIDE_COLUMNS_ROWS", {
        sheetId: env.model.getters.getActiveSheetId(),
        dimension: "COL",
...
export const HIDE_ROWS_NAME = (env) => {
...
export const HIDE_ROWS_ACTION = (env) => {
    const rows = env.model.getters.getElementsFromSelection("ROW");
    env.model.dispatch("HIDE_COLUMNS_ROWS", {
        sheetId: env.model.getters.getActiveSheetId(),
        dimension: "ROW",
...
export const UNHIDE_ALL_ROWS_ACTION = (env) => {
    const sheet = env.model.getters.getActiveSheet();
    env.model.dispatch("UNHIDE_COLUMNS_ROWS", {
        sheetId: sheet.id,
        dimension: "ROW",
...
export const UNHIDE_ROWS_ACTION = (env) => {
...
// Sheets
//------------------------------------------------------------------------------
export const CREATE_SHEET_ACTION = (env) => {
...
// Style/Format
//------------------------------------------------------------------------------
export const FORMAT_GENERAL_ACTION = (env) => setFormatter(env, "");
export const FORMAT_NUMBER_ACTION = (env) => setFormatter(env, "#,##0.00");
export const FORMAT_PERCENT_ACTION = (env) => setFormatter(env, "0.00%");
export const FORMAT_DATE_ACTION = (env) => setFormatter(env, "m/d/yyyy");
export const FORMAT_TIME_ACTION = (env) => setFormatter(env, "hh:mm:ss a");
export const FORMAT_DATE_TIME_ACTION = (env) => setFormatter(env, "m/d/yyyy hh:mm:ss");
export const FORMAT_DURATION_ACTION = (env) => setFormatter(env, "hhhh:mm:ss");
export const FORMAT_BOLD_ACTION = (env) => setStyle(env, { bold: !env.model.getters.getCurrentStyle().bold });
export const FORMAT_ITALIC_ACTION = (env) => setStyle(env, { italic: !env.model.getters.getCurrentStyle().italic });
export const FORMAT_STRIKETHROUGH_ACTION = (env) => setStyle(env, { strikethrough: !env.model.getters.getCurrentStyle().strikethrough });
export const FORMAT_UNDERLINE_ACTION = (env) => setStyle(env, { underline: !env.model.getters.getCurrentStyle().underline });
//------------------------------------------------------------------------------
// Side panel
//------------------------------------------------------------------------------
export const OPEN_CF_SIDEPANEL_ACTION = (env) => {
    env.openSidePanel("ConditionalFormatting", { selection: env.model.getters.getSelectedZones() });
};
export const OPEN_FAR_SIDEPANEL_ACTION = (env) => {
    env.openSidePanel("FindAndReplace", {});
};
export const INSERT_LINK = (env) => {
    env.openLinkEditor();
};
//------------------------------------------------------------------------------
// Sorting action
//------------------------------------------------------------------------------
export const SORT_CELLS_ASCENDING = (env) => {
    const { anchor, zones } = env.model.getters.getSelection();
    const sheetId = env.model.getters.getActiveSheetId();
    interactiveSortSelection(env, sheetId, anchor, zones[0], "ascending");
};
export const SORT_CELLS_DESCENDING = (env) => {
    const { anchor, zones } = env.model.getters.getSelection();
    const sheetId = env.model.getters.getActiveSheetId();
    interactiveSortSelection(env, sheetId, anchor, zones[0], "descending");
};
export const IS_ONLY_ONE_RANGE = (env) => {
    return env.model.getters.getSelectedZones().length === 1;
};
//# sourceMappingURL=menu_items_actions.js.map