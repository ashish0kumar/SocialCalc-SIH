...
import { isGridDependent, isPositionDependent, isSheetDependent, isTargetDependent, isZoneDependent, } from "../../types";
 ...
 */
export function transform(toTransform, executed) {
 ...
 */
export function transformAll(toTransform, executed) {
