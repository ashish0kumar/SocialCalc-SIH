...
import { isBoolean, isDateTime, isMarkdownLink, isMarkdownSheetLink, isWebLink, markdownLink, } from "../misc";
import { isNumber, parseNumber } from "../numbers";
import { BadExpressionCell, BooleanCell, DateTimeCell, EmptyCell, FormulaCell, NumberCell, SheetLinkCell, TextCell, WebLinkCell, } from "./cell_types";
cellRegistry
    .add("Formula", {
    sequence: 10,
 ...
 * ```
 */
export function cellFactory(getters) {
...
//# sourceMappingURL=cell_factory.js.map