import { Component, onMounted, onPatched, onWillUnmount, useExternalListener, useRef, useState, xml, } from "@odoo/owl";
import { AUTOFILL_EDGE_LENGTH, BACKGROUND_GRAY_COLOR, DEFAULT_CELL_HEIGHT, HEADER_HEIGHT, HEADER_WIDTH, LINK_TOOLTIP_HEIGHT, LINK_TOOLTIP_WIDTH, SCROLLBAR_WIDTH, TOPBAR_HEIGHT, } from "../constants";
import { findCellInNewZone, findVisibleHeader, getNextVisibleCellCoords, isInside, MAX_DELAY, range, } from "../helpers/index";
...
export function useCellHovered(env, getViewPort) {
    const hoveredPosition = useState({});
...
export class Grid extends Component {
    ...
    setup() {
        ...
        onWillUnmount(() => this.env.model.off("notify-ui", this));
        onPatched(() => {
            this.drawGrid();
            this.resizeGrid();
        });
