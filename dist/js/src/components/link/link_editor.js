...
`;
export class LinkEditor extends Component {
    constructor() {
        super(...arguments);
        ...
        this.linkEditorRef = useRef("linkEditor");
        this.position = useAbsolutePosition(this.linkEditorRef);
        this.urlInput = useRef("urlInput");
    }
    setup() {
        onMounted(() => { var _a; return (_a = this.urlInput.el) === null || _a === void 0 ? void 0 : _a.focus(); });
    }
    get defaultState() {
...
//# sourceMappingURL=link_editor.js.map