import { BOTTOMBAR_HEIGHT, DEFAULT_CELL_HEIGHT, DEFAULT_CELL_WIDTH, HEADER_HEIGHT, HEADER_WIDTH, MIN_COL_WIDTH, MIN_ROW_HEIGHT, SCROLLBAR_WIDTH, TOPBAR_HEIGHT, } from "./constants";
...
import { computeTextWidth, formatDecimal, isMarkdownLink, markdownLink, numberToLetters, parseMarkdownLink, toCartesian, toXC, toZone, UuidGenerator, } from "./helpers/index";
import { corePluginRegistry, uiPluginRegistry } from "./plugins/index";
import { autofillModifiersRegistry, autofillRulesRegistry, cellMenuRegistry, cellRegistry, colMenuRegistry, createFullMenuItem, inverseCommandRegistry, linkMenuRegistry, otRegistry, rowMenuRegistry, sheetMenuRegistry, sidePanelRegistry, topbarComponentRegistry, topbarMenuRegistry, } from "./registries/index";
/**
