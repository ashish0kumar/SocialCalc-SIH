...
import { addColumns, createSheet, moveAnchorCell, selectCell, selectColumn, } from "../test_helpers/commands_helpers";
...
describe("Collaborative selection", () => {
    ...
    test("Everyone starts in A1", () => {
        ...
        expect([alice, bob, charlie]).toHaveSynchronizedValue((user) => user.getters.getConnectedClients(), new Set([
            {
                id: "alice",
                name: "Alice",
    ...
    test("Position is remove on client left", () => {
        ...
        jest.advanceTimersByTime(DEBOUNCE_TIME + 100);
        expect([alice, bob, charlie, david]).toHaveSynchronizedValue((user) => user.getters.getConnectedClients(), new Set([
            {
                id: "alice",
                name: "Alice",
                position: { col: 0, row: 0, sheetId },
    ...
    test("Can send custom data in client", () => {
        ...
        new Model(alice.exportData(), {
            transportService: network,
            client: { id: "david", name: "David", customId: "1" },
        });
        jest.advanceTimersByTime(DEBOUNCE_TIME + 100);
        expect([alice, bob, charlie]).toHaveSynchronizedValue((user) => user.getters.getConnectedClients(), new Set([
            {
...
//# sourceMappingURL=collaborative_selection.test.js.map