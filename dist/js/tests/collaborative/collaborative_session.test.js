...
describe("Collaborative session", () => {
    ...
    beforeEach(() => {
        ...
        const revisionLog = buildRevisionLog("START_REVISION", () => ({ changes: [], commands: [] }), () => 0 /* Success */);
    ...
    test("local client move", () => {
        ...
        expect(session.getConnectedClients()).toEqual(new Set([{ ...client, position: { sheetId: "sheetId", col: 1, row: 2 } }]));
    });
    ...
    test("Can send custom data in client", () => {
        ...
        const model = new Model({}, {
            ...
            client: { id: "alice", name: "Alice", customId: "1" },
        });
...
//# sourceMappingURL=collaborative_session.test.js.map