...
import { createSheet, selectCell, setAnchorCorner, setCellContent, } from "../test_helpers/commands_helpers";
import { getCell, getCellContent } from "../test_helpers/getters_helpers";
import { getPlugin } from "../test_helpers/helpers";
function setFormat(model, format) {
...
function setDecimal(model, step) {
...
describe("formatting values (with formatters)", () => {
    ...
    test("Cannot set format in invalid sheet", () => {
        const model = new Model();
        expect(model.dispatch("SET_FORMATTING", {
            sheetId: "invalid sheet Id",
            target: [toZone("A1")],
        })).toBeCancelledBecause(21 /* InvalidSheetId */);
    });
});
...
describe("Autoresize", () => {
    ...
    beforeEach(() => {
        ...
        sheetUIPlugin.getCellWidth = jest.fn((cell) => {
            if (cell["content"] === "size0")
                return sizes[0];
            return sizes[1];
        });
    });
    test("Can autoresize a column", () => {
        ...
        expect((_a = model.getters.getCol(sheetId, 0)) === null || _a === void 0 ? void 0 : _a.size).toBe(sizes[0] + padding);
    });
    test("Can autoresize two columns", () => {
        ...
        expect((_a = model.getters.getCol(sheetId, 0)) === null || _a === void 0 ? void 0 : _a.size).toBe(sizes[0] + padding);
        expect((_b = model.getters.getCol(sheetId, 2)) === null || _b === void 0 ? void 0 : _b.size).toBe(sizes[1] + padding);
    });
    test("Can autoresize a row", () => {
        var _a;
        setCellContent(model, "A1", "test");
        model.dispatch("AUTORESIZE_ROWS", { sheetId, rows: [0] });
        expect((_a = model.getters.getRow(sheetId, 0)) === null || _a === void 0 ? void 0 : _a.size).toBe(rowSize + padding);
    });
    test("Can autoresize two rows", () => {
        ...
        expect((_a = model.getters.getRow(sheetId, 0)) === null || _a === void 0 ? void 0 : _a.size).toBe(rowSize + padding);
        expect((_b = model.getters.getRow(sheetId, 2)) === null || _b === void 0 ? void 0 : _b.size).toBe(fontSizeMap[24] + padding);
    });
    test("Can autoresize a column in another sheet", () => {
        var _a, _b, _c;
        const initialSize = (_a = model.getters.getCol(sheetId, 0)) === null || _a === void 0 ? void 0 : _a.size;
        const newSheetId = "42";
        ...
        expect((_b = model.getters.getCol(sheetId, 0)) === null || _b === void 0 ? void 0 : _b.size).toBe(initialSize);
        expect((_c = model.getters.getCol(newSheetId, 0)) === null || _c === void 0 ? void 0 : _c.size).toBe(sizes[0] + padding);
    });
    test("Can autoresize a row in another sheet", () => {
        var _a, _b, _c;
        const initialSize = (_a = model.getters.getRow(sheetId, 0)) === null || _a === void 0 ? void 0 : _a.size;
        const newSheetId = "42";
        createSheet(model, { sheetId: newSheetId });
        setCellContent(model, "A1", "test", newSheetId);
        model.dispatch("AUTORESIZE_ROWS", { sheetId: newSheetId, rows: [0] });
        expect((_b = model.getters.getRow(sheetId, 0)) === null || _b === void 0 ? void 0 : _b.size).toBe(initialSize);
        expect((_c = model.getters.getRow(newSheetId, 0)) === null || _c === void 0 ? void 0 : _c.size).toBe(rowSize + padding);
    });
});
