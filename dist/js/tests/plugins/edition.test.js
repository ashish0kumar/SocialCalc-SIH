...
import { activateSheet, addCellToSelection, createSheet, createSheetWithName, merge, moveAnchorCell, renameSheet, resizeAnchorZone, selectCell, setAnchorCorner, setCellContent, setSelection, } from "../test_helpers/commands_helpers";
...
describe("edition", () => {
    ...
    test("setting content with wrong selection", () => {
        ...
        expect(result).toBeCancelledBecause(29 /* WrongComposerSelection */);
    });
    ...
    test("Allow setting right-to-left selection", () => {
        ...
        expect(model.dispatch("CHANGE_COMPOSER_CURSOR_SELECTION", {
            start: 2,
            end: 1,
    ...
    test("setting selection out of content is invalid", () => {
        ...
        })).toBeCancelledBecause(29 /* WrongComposerSelection */);
    });
    ...
    test("Allow start edition with a right-to-left selection", () => {
        const model = new Model();
        expect(model.dispatch("START_EDITION", {
            text: "coucou",
    ...
    test.each(["2%", "20.1%", "20.000001%"])("display percentages as percentages in composer", (content) => {
        const model = new Model();
...
//# sourceMappingURL=edition.test.js.map