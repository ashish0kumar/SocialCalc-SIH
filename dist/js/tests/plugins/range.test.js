...
import { addColumns, addRows, createSheet, deleteColumns, deleteRows, deleteSheet, renameSheet, } from "../test_helpers/commands_helpers";
...
PluginTestRange.getters = ["getUsedRanges", "getRanges"];
...
describe("range plugin", () => {
    ...
    describe("restoring a range as string", () => {
        ...
        test.each(["Sheet 0", "<Sheet1>", "&Sheet2", "Sheet4;", "Sheet5🐻"])("sheet name with special character %s", (name) => {
