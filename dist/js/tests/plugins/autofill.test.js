...
import { createSheet, createSheetWithName, deleteColumns, deleteRows, merge, setCellContent, setSelection, } from "../test_helpers/commands_helpers";
...
function autofillTooltip(from, to) {
    var _a;
    setSelection(model, [from]);
    const [col, row] = toCartesian(to);
    model.dispatch("AUTOFILL_SELECT", { col, row });
    return (_a = model.getters.getAutofillTooltip()) === null || _a === void 0 ? void 0 : _a.props.content;
}
/**
 * Retrieve the direction from a zone to a cell
 */
function getDirection(from, xc) {
    setSelection(model, [from]);
...
describe("Autofill", () => {
    ...
    describe("Autofill multiple values", () => {
        ...
        test.each([
            ...
            deleteRows(model, [0]);
            expect((_a = getCell(model, "C1")) === null || _a === void 0 ? void 0 : _a.content).toBe(expectedInvalidFormula);
            autofill("C1", "C2");
            autofill("C1", "D1");
            expect((_b = getCell(model, "C2")) === null || _b === void 0 ? void 0 : _b.content).toBe(expectedInvalidFormula);
            expect((_c = getCell(model, "D1")) === null || _c === void 0 ? void 0 : _c.content).toBe(expectedInvalidFormula);
        });
        test.each([
            ["=A1", "=#REF"],
            ["=SUM(A1:A2)", "=SUM(#REF)"],
            ...
            expect((_a = getCell(model, "A1")) === null || _a === void 0 ? void 0 : _a.content).toBe(expectedInvalidFormula);
            autofill("A1", "A2");
            autofill("A1", "B1");
            expect((_b = getCell(model, "A2")) === null || _b === void 0 ? void 0 : _b.content).toBe(expectedInvalidFormula);
            expect((_c = getCell(model, "B1")) === null || _c === void 0 ? void 0 : _c.content).toBe(expectedInvalidFormula);
        });
        test.each([
            ...
            autofill("A1", "A2");
            expect((_a = getCell(model, "A2")) === null || _a === void 0 ? void 0 : _a.content).toBe(link);
        });
    ...
    test("autofill with merge in selection", () => {
        ...
        setCellContent(model, "A1", "1");
        autofill("A1:A3", "A9");
        expect(getMergeCellMap(model)).toEqual(XCToMergeCellMap(model, ["A1", "A2", "A4", "A5", "A7", "A8"]));
...
//# sourceMappingURL=autofill.test.js.map