...
class Parent extends Component {
    setup() {
        this.props.model.dispatch = jest.fn(() => 0 /* Success */);
        useSubEnv({
            openSidePanel: (panel) => { },
...
async function mountTopBar(model = new Model()) {
...
describe("BottomBar component", () => {
  ...
  `;
    ...
    test("Can open the list of sheets", async () => {
        ...
        expect(sheets[0].dataset.name).toBe(sheet);
        expect(sheets[1].dataset.name).toBe("42");
        app.destroy();
    });
    ...
    test("Display the statistic button only if no-empty cells are selected", async () => {
        ...
        selectCell(model, "A2");
        await nextTick();
        expect((_a = fixture.querySelector(".o-selection-statistic")) === null || _a === void 0 ? void 0 : _a.textContent).toBe("Sum: 24");
        selectCell(model, "A3");
        await nextTick();
        expect(fixture.querySelector(".o-selection-statistic")).toBeFalsy();
        app.destroy();
    ...
    test("Display empty information if the statistic function doesn't handle the types of the selected cells", async () => {
        ...
        selectCell(model, "A2");
        await nextTick();
        expect((_a = fixture.querySelector(".o-selection-statistic")) === null || _a === void 0 ? void 0 : _a.textContent).toBe("Sum: __");
    });
    ...
    test("Can activate a statistic from the list of statistics", async () => {
        ...
        await nextTick();
        expect((_b = fixture.querySelector(".o-selection-statistic")) === null || _b === void 0 ? void 0 : _b.textContent).toBe("Count Numbers: 1");
        app.destroy();
    });
});
