...
import { rightClickCell, setInputValueAndTrigger, simulateClick, } from "../../test_helpers/dom_helper";
...
describe("link editor component", () => {
    ...
    let grid;
    let app;
    async function openLinkEditor(model, xc) {
        await rightClickCell(model, xc);
        await simulateClick(".o-menu-item[data-name='insert_link']");
    }
    function labelInput() {
        const inputs = fixture === null || fixture === void 0 ? void 0 : fixture.querySelectorAll("input");
        return inputs[0];
    }
    function urlInput() {
        const inputs = fixture === null || fixture === void 0 ? void 0 : fixture.querySelectorAll("input");
    ...
    test.each(["hello", "4", "TRUE", "10/10/2021", "=4", '="hello"', "=TRUE", "=10/10/2021"])("open link editor in a simple cell: %s", async (cellContent) => {
        var _a;
        setCellContent(model, "A1", cellContent);
        await openLinkEditor(model, "A1");
        expect(labelInput().value).toBe((_a = getCell(model, "A1")) === null || _a === void 0 ? void 0 : _a.formattedValue);
        expect(urlInput().value).toBe("");
    });
    ...
    test.each([urlInput, labelInput])("cannot save with enter while url input is empty", async (input) => {
        await openLinkEditor(model, "A1");
...
//# sourceMappingURL=link_editor.test.js.map