...
import { DEFAULT_CELL_HEIGHT, DEFAULT_CELL_WIDTH, DEFAULT_FONT_SIZE, HEADER_WIDTH, MIN_COL_WIDTH, MIN_ROW_HEIGHT, PADDING_AUTORESIZE, } from "../../src/constants";
import { fontSizeMap } from "../../src/fonts";
import { lettersToNumber, scrollDelay, toXC, toZone } from "../../src/helpers/index";
import { Model } from "../../src/model";
import { hideColumns, hideRows, redo, setCellContent, undo, } from "../test_helpers/commands_helpers";
 ...
 */
async function selectColumn(letter, extra = {}) {
 ...
 */
async function resizeColumn(letter, delta) {
    const index = lettersToNumber(letter);
    const x = model.getters.getCol(model.getters.getActiveSheetId(), index).start + 1;
    triggerMouseEvent(".o-overlay .o-col-resizer", "mousemove", x, 10);
    await nextTick();
 ...
 */
async function dragColumn(startLetter, endLetter) {
 ...
 */
async function dblClickColumn(letter) {
    const index = lettersToNumber(letter);
 ...
 * @param extra shiftKey, ctrlKey
 */
async function selectRow(index, extra = {}) {
 ...
 * @param delta Size to add (or remove if delta < 0)
 */
async function resizeRow(index, delta) {
    const y = model.getters.getRow(model.getters.getActiveSheetId(), index).start + 1;
    triggerMouseEvent(".o-overlay .o-row-resizer", "mousemove", 10, y);
    await nextTick();
 ...
 */
async function dragRow(startIndex, endIndex) {
 ...
 */
async function dblClickRow(index) {
...
describe("Resizer component", () => {
    ...
    test("Can resize a column", async () => {
        ...
        expect(model.getters.getCol(model.getters.getActiveSheetId(), 1).size).toBe(model.getters.getCol(model.getters.getActiveSheetId(), 0).size + 50);
        expect(model.getters.getCol(model.getters.getActiveSheetId(), 2).size).toBe(model.getters.getCol(model.getters.getActiveSheetId(), 0).size);
    });
    test("Can resize a row", async () => {
        await resizeRow(2, 50);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 1).size).toBe(model.getters.getRow(model.getters.getActiveSheetId(), 0).size + 50);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 2).size).toBe(model.getters.getRow(model.getters.getActiveSheetId(), 0).size);
    });
    test("Can resize multiples columns", async () => {
        ...
        expect(model.getters.getCol(model.getters.getActiveSheetId(), 1).size).toBe(model.getters.getCol(model.getters.getActiveSheetId(), 0).size);
        expect(model.getters.getCol(model.getters.getActiveSheetId(), 2).size).toBe(model.getters.getCol(model.getters.getActiveSheetId(), 0).size + 50);
        expect(model.getters.getCol(model.getters.getActiveSheetId(), 3).size).toBe(model.getters.getCol(model.getters.getActiveSheetId(), 0).size + 50);
        expect(model.getters.getCol(model.getters.getActiveSheetId(), 4).size).toBe(model.getters.getCol(model.getters.getActiveSheetId(), 0).size);
        expect(model.getters.getCol(model.getters.getActiveSheetId(), 4).start).toBe(model.getters.getCol(model.getters.getActiveSheetId(), 0).size * 4 + 100);
    });
    test("Can resize multiples rows", async () => {
        ...
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 1).size).toBe(model.getters.getRow(model.getters.getActiveSheetId(), 0).size);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 2).size).toBe(model.getters.getRow(model.getters.getActiveSheetId(), 0).size + 50);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 3).size).toBe(model.getters.getRow(model.getters.getActiveSheetId(), 0).size + 50);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 4).size).toBe(model.getters.getRow(model.getters.getActiveSheetId(), 0).size);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 4).start).toBe(model.getters.getRow(model.getters.getActiveSheetId(), 0).size * 4 + 100);
    });
    ...
    test("Select 123 5, dblclick 5 then resize all", async () => {
        ...
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 3).size).toBe(DEFAULT_CELL_HEIGHT);
    ...
    test("Select 123 5, dblclick 6 then resize only 6", async () => {
        ...
        await selectRow(4, { ctrlKey: true });
        await dblClickRow(5);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 0).size).toBe(DEFAULT_CELL_HEIGHT);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 1).size).toBe(DEFAULT_CELL_HEIGHT);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 2).size).toBe(DEFAULT_CELL_HEIGHT);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 3).size).toBe(DEFAULT_CELL_HEIGHT);
        expect(model.getters.getRow(model.getters.getActiveSheetId(), 4).size).toBe(DEFAULT_CELL_HEIGHT);
        const size = fontSizeMap[DEFAULT_FONT_SIZE] + 2 * PADDING_AUTORESIZE;
    ...
    test("hide BCD, unhide it", async () => {
        ...
        triggerMouseEvent(".o-overlay .o-col-resizer .o-unhide[data-index='0']:nth-child(1)", "click", x, 10);
        expect(model.getters.getHiddenColsGroups(model.getters.getActiveSheetId())).toEqual([]);
        // from the right
        undo(model);
        expect(model.getters.getHiddenColsGroups(model.getters.getActiveSheetId())).toEqual([
        ...
        triggerMouseEvent(".o-overlay .o-col-resizer .o-unhide[data-index='0']:nth-child(2)", "click", x, 10);
        expect(model.getters.getHiddenColsGroups(model.getters.getActiveSheetId())).toEqual([]);
    });
    ...
    test("hide 1, unhide it", async () => {
        ...
        triggerMouseEvent(".o-overlay .o-row-resizer .o-unhide[data-index='0']", "click", HEADER_WIDTH - 5, y);
    ...
    test("hide 2:4, unhide it", async () => {
        ...
        triggerMouseEvent(".o-overlay .o-row-resizer .o-unhide[data-index='0']:nth-child(1)", "click", HEADER_WIDTH - 5, y);
        expect(model.getters.getHiddenRowsGroups(model.getters.getActiveSheetId())).toEqual([]);
        // from the right
        undo(model);
        expect(model.getters.getHiddenRowsGroups(model.getters.getActiveSheetId())).toEqual([
        ...
        triggerMouseEvent(".o-overlay .o-row-resizer .o-unhide[data-index='0']:nth-child(2)", "click", HEADER_WIDTH - 5, y);
        expect(model.getters.getHiddenRowsGroups(model.getters.getActiveSheetId())).toEqual([]);
    });
    ...
    test("hide 0, 2, 4,5 and unhide 2", async () => {
        ...
        triggerMouseEvent(".o-overlay .o-row-resizer .o-unhide[data-index='1']", "click", HEADER_WIDTH - 5, y);
        expect(model.getters.getHiddenRowsGroups(model.getters.getActiveSheetId())).toEqual([
            [0],
            [4, 5],
        ]);
