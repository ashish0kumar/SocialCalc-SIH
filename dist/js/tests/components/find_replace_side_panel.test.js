...
const selectors = {
    ...
    inputSearch: ".o-sidePanel .o-find-and-replace .o-section:nth-child(1) .o-input-search-container input",
    ...
    checkBoxMatchingCase: ".o-sidePanel .o-find-and-replace .o-section:nth-child(1) .o-far-item:nth-child(1) input",
    checkBoxExactMatch: ".o-sidePanel .o-find-and-replace .o-section:nth-child(1) .o-far-item:nth-child(2) input",
    checkBoxSearchFormulas: ".o-sidePanel .o-find-and-replace .o-section:nth-child(1) .o-far-item:nth-child(3) input",
    checkBoxReplaceFormulas: ".o-sidePanel .o-find-and-replace .o-section:nth-child(3) .o-far-item:nth-child(3) input",
};
describe("find and replace sidePanel component", () => {
    ...
    describe("Sidepanel", () => {
        ...
        test("focusing the sidepanel will update the search", async () => {
            ...
            await nextTick();
            const inputSearch = document.activeElement;
            expect(document.activeElement).toBe(document.querySelector(selectors.inputSearch));
            inputSearch.blur();
        ...
        test("disable next/previous/replace/replaceAll if searching on empty string", async () => {
            ...
            await nextTick();
            expect(document.querySelector(selectors.previousButton).disabled).toBe(true);
            expect(document.querySelector(selectors.nextButton).disabled).toBe(true);
            expect(document.querySelector(selectors.replaceButton).disabled).toBe(true);
            expect(document.querySelector(selectors.replaceAllButton).disabled).toBe(true);
        });
    });
...
//# sourceMappingURL=find_replace_side_panel.test.js.map