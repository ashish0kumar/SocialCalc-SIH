...
import { makeTestFixture, mountSpreadsheet, nextTick, resetFunctions, typeInComposerGrid as typeInComposerGridHelper, } from "../test_helpers/helpers";
...
describe("Functions autocomplete", () => {
    ...
    describe("autocomplete", () => {
        ...
        test("=S+UP cycle to the last item", async () => {
            await typeInComposerGrid("=S");
            expect(fixture.querySelector(".o-autocomplete-value-focus .o-autocomplete-value").textContent).toBe("SUM");
            composerEl.dispatchEvent(new KeyboardEvent("keydown", { key: "ArrowUp" }));
            await nextTick();
            expect(fixture.querySelector(".o-autocomplete-value-focus .o-autocomplete-value").textContent).toBe("SZZ");
        });
...
//# sourceMappingURL=autocomplete_dropdown.test.js.map