...
import { makeTestFixture, mountSpreadsheet, nextTick, resetFunctions, typeInComposerGrid, } from "../test_helpers/helpers";
...
describe("formula assistant", () => {
    ...
    describe("appearance", () => {
        ...
        test("=FUNC1(FUNC2( show formula assistant for 2nd function", async () => {
            ...
            expect(document.activeElement).toBe(composerEl);
            expect(fixture.querySelectorAll(".o-formula-assistant")).toHaveLength(1);
            expect(fixture.querySelectorAll(".o-formula-assistant-head span")[0].textContent).toBe("FUNC2");
        });
        test("=FUNC1(FUNC2() show formula assistant for 1st function", async () => {
            await typeInComposerGrid("=FUNC1(FUNC2()");
            expect(document.activeElement).toBe(composerEl);
            expect(fixture.querySelectorAll(".o-formula-assistant")).toHaveLength(1);
            expect(fixture.querySelectorAll(".o-formula-assistant-head span")[0].textContent).toBe("FUNC1");
        });
        ...
        describe("function definition", () => {
            test("function without argument", async () => {
                ...
                expect(fixture.querySelectorAll(".o-formula-assistant-head")[0].textContent).toBe("FUNC0 (  ) ");
            });
            test("normal function", async () => {
                await typeInComposerGrid("=FUNC1(");
                expect(fixture.querySelectorAll(".o-formula-assistant-head")[0].textContent).toBe("FUNC1 ( f1Arg1, f1Arg2 ) ");
            });
            test("function with default argument", async () => {
                await typeInComposerGrid("=FUNC2(");
                expect(fixture.querySelectorAll(".o-formula-assistant-head")[0].textContent).toBe("FUNC2 ( f2Arg1, [f2Arg2] ) ");
            });
            test("function with repeatable argument", async () => {
                await typeInComposerGrid("=FUNC3(");
                expect(fixture.querySelectorAll(".o-formula-assistant-head")[0].textContent).toBe("FUNC3 ( f3Arg1, [f3Arg2, ...] ) ");
            });
        });
        describe("arguments description", () => {
            ...
            test("normal argument", async () => {
                ...
                expect(fixture.querySelectorAll(".o-formula-assistant-arg div")[2].textContent).toBe("f1Arg2");
                expect(fixture.querySelectorAll(".o-formula-assistant-arg div")[3].textContent).toBe("f1 Arg2 def");
            });
            test("function with default argument", async () => {
                await typeInComposerGrid("=FUNC2(");
                expect(fixture.querySelectorAll(".o-formula-assistant-arg")).toHaveLength(2);
                expect(fixture.querySelectorAll(".o-formula-assistant-arg div")[2].textContent).toBe("f2Arg2 - [optional] TRUE by default");
                expect(fixture.querySelectorAll(".o-formula-assistant-arg div")[3].textContent).toBe("f2 Arg2 def");
            });
            test("function with repeatable argument", async () => {
                await typeInComposerGrid("=FUNC3(");
                expect(fixture.querySelectorAll(".o-formula-assistant-arg")).toHaveLength(2);
                expect(fixture.querySelectorAll(".o-formula-assistant-arg div")[2].textContent).toBe("f3Arg2 - [optional] repeatable");
                expect(fixture.querySelectorAll(".o-formula-assistant-arg div")[3].textContent).toBe("f3 Arg2 def");
            });
        });
    });
    describe("focus argument", () => {
        test("=FUNC1( focus index on 1st arg", async () => {
            await typeInComposerGrid("=FUNC1(");
            expect(fixture.querySelectorAll(".o-formula-assistant-arg.o-formula-assistant-focus span")[0]
                .textContent).toBe("f1Arg1");
        });
        ...
        test("functions with more arguments than allowed do not have focus", async () => {
            ...
            expect(fixture.querySelectorAll(".o-formula-assistant-arg.o-formula-assistant-focus span")).toHaveLength(0);
        });
...
//# sourceMappingURL=formula_assistant.test.js.map