...
import { selectCell, setAnchorCorner, setCellContent, setSelection, } from "../test_helpers/commands_helpers";
import { triggerMouseEvent } from "../test_helpers/dom_helper";
import { getBorder, getCell } from "../test_helpers/getters_helpers";
import { makeTestFixture, mountSpreadsheet, nextTick, typeInComposerTopBar, } from "../test_helpers/helpers";
...
class Parent extends Component {
    constructor() {
        super(...arguments);
        this.state = useState({ focusComposer: false });
    }
    setup() {
        useSubEnv({
            openSidePanel: () => { },
...
Parent._t = t;
async function mountParent(model = new Model(), focusComposer = false) {
...
describe("TopBar component", () => {
    ...
    test("Can add a custom component to topbar", async () => {
        ...
        Comp.template = xml `<div class="o-topbar-test">Test</div>`;
    ...
    test("Can add multiple components to topbar with different visibilities", async () => {
        ...
        Comp1.template = xml `<div class="o-topbar-test1">Test1</div>`;
        class Comp2 extends Component {
        }
        Comp2.template = xml `<div class="o-topbar-test2">Test2</div>`;
...
//# sourceMappingURL=top_bar.test.js.map