...
describe("AND formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=AND(A2:A5)", A2: "test", A3: "TRUE", A4: "FALSE" })).toBe(false);
        expect(evaluateCell("A1", { A1: "=AND(A2:A5)", A2: "test", A3: "TRUE", A4: "TRUE" })).toBe(true);
    });
...
describe("IF formula", () => {
    ...
    test("functional tests on cell arguments with errors", () => {
        expect(evaluateCell("A1", { A1: "=IF(A2, A3, A4)", A2: "TRUE", A3: "42", A4: "=1/0" })).toBe(42);
        expect(evaluateCell("A1", { A1: "=IF(A2, A3, A4)", A2: "TRUE", A3: "=1/0", A4: "42" })).toBe("#ERROR"); // @compatibility: on google sheets, return #DIV/0!
    });
    test("casting tests on cell arguments", () => {
...
describe("IFS formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=IFS(A2, A3, A4, A5)", A2: "42", A3: "ok1", A4: "TRUE", A5: "ok2" })).toBe("ok1");
        expect(evaluateCell("A1", { A1: "=IFS(A2, A3, A4, A5)", A2: "0", A3: "ok1", A4: "TRUE", A5: "ok2" })).toBe("ok2");
        expect(evaluateCell("A1", {
            A1: "=IFS(A2, A3, A4, A5)",
            A2: "test",
            A3: "ok1",
...
describe("OR formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=OR(A2:A5)", A2: "test", A3: "TRUE", A4: "FALSE" })).toBe(true);
        expect(evaluateCell("A1", { A1: "=OR(A2:A5)", A2: "test", A3: "TRUE", A4: "TRUE" })).toBe(true);
        expect(evaluateCell("A1", { A1: "=OR(A2:A5)", A2: "test", A3: "FALSE", A4: "FALSE" })).toBe(false);
    });
    test("casting tests on cell arguments", () => {
...
describe("XOR formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=XOR(A2:A5)", A2: "test", A3: "TRUE", A4: "FALSE" })).toBe(true);
        expect(evaluateCell("A1", { A1: "=XOR(A2:A5)", A2: "test", A3: "TRUE", A4: "TRUE" })).toBe(false);
        expect(evaluateCell("A1", { A1: "=XOR(A2:A5)", A2: "TRUE", A3: "TRUE", A4: "TRUE" })).toBe(true);
        expect(evaluateCell("A1", { A1: "=XOR(A2:A5)", A2: "FALSE", A3: "FALSE", A4: "FALSE" })).toBe(false);
        expect(evaluateCell("A1", { A1: "=XOR(A2:A5)", A2: "FALSE", A3: "TRUE", A4: "TRUE" })).toBe(false);
        expect(evaluateCell("A1", { A1: "=XOR(A2:A5)", A2: "test", A3: "FALSE", A4: "FALSE" })).toBe(false);
    });
    test("casting tests on cell arguments", () => {
...
//# sourceMappingURL=module_logical.test.js.map