    ...
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DB(A2, 10, 10, 2)", A2: '="100"' })).toBeCloseTo(16.3564, 5);
            });
        ...
        describe("on 2nd argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DB(100, "10", 10, 2)' })).toBeCloseTo(16.3564, 5);
                expect(evaluateCell("A1", { A1: "=DB(100, A2, 10, 2)", A2: '="10"' })).toBeCloseTo(16.3564, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
        ...
        describe("on 3th argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DB(100, 10, "10", 2)' })).toBeCloseTo(16.3564, 5);
                expect(evaluateCell("A1", { A1: "=DB(100, 10, A2, 2)", A2: '="10"' })).toBeCloseTo(16.3564, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=DB(100, 10, " ", 2)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
        ...
        describe("on 4th argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DB(100, 10, 10, "2")' })).toBeCloseTo(16.3564, 5);
                expect(evaluateCell("A1", { A1: "=DB(100, 10, 10, A2)", A2: '="2"' })).toBeCloseTo(16.3564, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
        ...
        describe("on 5th argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DB(120, 10, 10, 1, A2)", A2: '="1"' })).toBeCloseTo(2.2, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DB(120, 10, 10, 1, A2)", A2: "TRUE" })).toBeCloseTo(2.2, 5);
            });
        });
    });
});
describe("DURATION formula", () => {
    ...
    describe("business logic", () => {
        describe("return the DURATION", () => {
            test("basic formula", () => {
                expect(evaluateCell("A1", { A1: '=DURATION("1/1/2000", "1/1/2040", 0.05, 0.1, 1, 0)' })).toBeCloseTo(11.38911, 5);
            });
            test.each([
                ["01/01/1999", 11.37412],
                ["01/01/2015", 11.25349],
            ])("variation on 1st argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=DURATION(A2, "1/1/2040", 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["01/01/2041", 11.37412],
                ["01/01/2010", 7.66086],
            ])("variation on 2nd argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=DURATION("1/1/2000", A2, 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 10.53998],
                ["0.02", 13.13158],
                ...
                expect(evaluateCell("A1", { A1: '=DURATION("1/1/2000", "1/1/2040", A2, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 7.87788],
                ["0.02", 23.38874],
                ...
                expect(evaluateCell("A1", { A1: '=DURATION("1/1/2000", "1/1/2040", 0.05, A2, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["2", 10.87578],
                ["4", 10.61808],
            ])("variation on 5th argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=DURATION("1/1/2000", "1/1/2040", 0.05, 0.1, A2, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            // test.each([
            //   ["1", 11.38911],
            //   ["2", 11.40578],
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=DURATION(A2, "12/12/21", 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([["12/11/2012"], ["12/12/2012"]])("parameter 2 must be greater than parameter 1", (arg) => {
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", A2, 0.05, 0.1, 1, 0)', A2: arg })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        });
        test.each([
            ["12/12/2021 23:00", 7.12859],
            ["12/12/2021", 7.12859],
        ])("parameter 2 is truncated", (arg, result) => {
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", A2, 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test("parameter 3 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", -0.1, 0.1, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", 0, 0.1, 1, 0)' })).toBeCloseTo(9, 5);
        });
        test("parameter 4 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", 0.05, -0.1, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", 0.05, 0, 1, 0)' })).toBeCloseTo(7.75862, 5);
        });
        test.each([
            ["0", "#ERROR"],
            ["1", 7.12859],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", 0.05, 0.1, A2, 0)', A2: arg }));
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", 0.05, 0.1, A2, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([
            ["-1", "#ERROR"],
            ["0", 7.12859],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", 0.05, 0.1, 1, A2)', A2: arg }));
            if (typeof result === "number") {
                expectedValue.toBeCloseTo(result);
            }
            else {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=DURATION("12/12/12", "12/12/21", 0.05, 0.1, 1, A2)', A2: arg })).toBeCloseTo(result, 5);
        });
    });
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DURATION(A2, 730, 0.1, 0.5, 1)", A2: '="0"' })).toBeCloseTo(1.88, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DURATION(A2, 730, 0.1, 0.5, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=DURATION(TRUE, 730, 0.1, 0.5, 1)" })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(FALSE, 730, 0.1, 0.5, 1)" })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(A2, 730, 0.1, 0.5, 1)", A2: "TRUE" })).toBeCloseTo(1.88, 5);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DURATION(0, "730", 0.1, 0.5, 1)' })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, A2, 0.1, 0.5, 1)", A2: '="730"' })).toBeCloseTo(1.88, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DURATION(0, A2, 0.1, 0.5, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DURATION(0, A2, 0.1, 0.5, 1)", A2: "TRUE" })).toBeCloseTo(0, 5);
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DURATION(0, 730, "0.1", 0.5, 1)' })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, A2, 0.5, 1)", A2: '="0.1"' })).toBeCloseTo(1.88, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, A2, 0.5, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, TRUE, 0.5, 1)" })).toBeCloseTo(1.57143, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, FALSE, 0.5, 1)" })).toBeCloseTo(2.0, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, A2, 0.5, 1)", A2: "TRUE" })).toBeCloseTo(1.57143, 5);
            });
        });
        describe("on 4th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DURATION(0, 730, 0.1, "0.5", 1)' })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, A2, 1)", A2: '="0.5"' })).toBeCloseTo(1.88, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, A2, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, TRUE, 1)" })).toBeCloseTo(1.84615, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, FALSE, 1)" })).toBeCloseTo(1.91667, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, A2, 1)", A2: "TRUE" })).toBeCloseTo(1.84615, 5);
            });
        });
        describe("on 5th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DURATION(0, 730, 0.1, 0.5, "1")' })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, A2)", A2: '="1"' })).toBeCloseTo(1.88, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, TRUE)" })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, FALSE)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, A2)", A2: "TRUE" })).toBeCloseTo(1.88, 5);
            });
        });
        describe("on 6th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, 1,  )" })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, 1, A2)" })).toBeCloseTo(1.88, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=DURATION(0, 730, 0.1, 0.5, 1, "0")' })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, 1, A2)", A2: '="0"' })).toBeCloseTo(1.88, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=DURATION(0, 730, 0.1, 0.5, 1, " ")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=DURATION(0, 730, 0.1, 0.5, 1, "kikou")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, 1, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, 1, TRUE)" })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, 1, FALSE)" })).toBeCloseTo(1.88, 5);
                expect(evaluateCell("A1", { A1: "=DURATION(0, 730, 0.1, 0.5, 1, A2)", A2: "TRUE" })).toBeCloseTo(1.88, 5);
            });
        });
    });
});
    ...
    describe("business logic", () => {
        describe("return the FV", () => {
            ...
            test.each([
                ...
                expect(evaluateCell("A1", { A1: "=FV(0.05, A2, 3, 70, 0)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["3.9", -163.0764],
                ["0", -114.02262],
                ...
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, A2, 70, 0)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["70.9", -153.22231],
                ["0", -37.73368],
                ...
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, 3, A2, 0)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.9", -153.64299],
                ["23", -153.64299],
            ])("variation on 5th argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, 3, 70, A2)", A2: arg })).toBeCloseTo(result, 5);
            });
        });
    });
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=FV("0.05", 10, 3, 70, 0)' })).toBeCloseTo(-151.7563, 5);
                expect(evaluateCell("A1", { A1: "=FV(A2, 10, 3, 70, 0)", A2: '="0.05"' })).toBeCloseTo(-151.7563, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=FV(A2, 10, 3, 70, 0)", A2: "TRUE" })).toBeCloseTo(-74749, 5);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=FV(0.05, "10", 3, 70, 0)' })).toBeCloseTo(-151.7563, 5);
                expect(evaluateCell("A1", { A1: "=FV(0.05, A2, 3, 70, 0)", A2: '="10"' })).toBeCloseTo(-151.7563, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=FV(0.05, A2, 3, 70, 0)", A2: "TRUE" })).toBeCloseTo(-76.5, 5);
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=FV(0.05, 10, "3", 70, 0)' })).toBeCloseTo(-151.7563, 5);
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, A2, 70, 0)", A2: '="3"' })).toBeCloseTo(-151.7563, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, FALSE, 70, 0)" })).toBeCloseTo(-114.02262, 5);
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, A2, 70, 0)", A2: "TRUE" })).toBeCloseTo(-126.60052, 5);
            });
        });
        describe("on 4th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=FV(0.05, 10, 3, "70", 0)' })).toBeCloseTo(-151.7563, 5);
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, 3, A2, 0)", A2: '="70"' })).toBeCloseTo(-151.7563, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, 3, A2, 0)", A2: "TRUE" })).toBeCloseTo(-39.36257, 5);
            });
        });
        describe("on 5th argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as boolean", () => {
                expect(evaluateCell("A1", { A1: '=FV(0.05, 10, 3, 70, "TRUE")' })).toBeCloseTo(-153.64299, 5);
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, 3, 70, A2)", A2: '="TRUE"' })).toBeCloseTo(-153.64299, 5);
            });
            ...
            test("number/number in cell are interpreted as boolean", () => {
                ...
                expect(evaluateCell("A1", { A1: "=FV(0.05, 10, 3, 70, A2)", A2: "42" })).toBeCloseTo(-153.64299, 5);
            });
        });
    });
});
    ...
    describe("business logic", () => {
        ...
        describe("return the IRR", () => {
            ...
            test.each([
                ...
                expect(evaluateCell("A1", { A1: "=IRR(A2:A5," + arg + ")", ...grid })).toBeCloseTo(result, 5);
            });
        });
        test.each([
    ...
    describe("casting", () => {
        ...
        describe("on 2nd argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=IRR(A2:A3, A4)", ...grid, A4: '="0.1"' })).toBeCloseTo(-0.4, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=IRR(A2:A3, A4)", ...grid, A4: "TRUE" })).toBeCloseTo(-0.4, 5);
            });
        });
    });
});
describe("MDURATION formula", () => {
    test("take at 4 or 5 arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=MDURATION(0, 365, 0.05, 0.1, 1, 0)" })).toBeCloseTo(0.90909, 5);
    ...
    describe("business logic", () => {
        describe("return the MDURATION", () => {
            test("basic formula", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION("1/1/2000", "1/1/2040", 0.05, 0.1, 1, 0)' })).toBeCloseTo(10.35374, 5);
            });
            test.each([
                ["01/01/1999", 10.34011],
                ["01/01/2015", 10.23045],
            ])("variation on 1st argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=MDURATION(A2, "1/1/2040", 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["01/01/2041", 10.34011],
                ["01/01/2010", 6.96442],
            ])("variation on 2nd argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=MDURATION("1/1/2000", A2, 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 9.5818],
                ["0.02", 11.9378],
                ...
                expect(evaluateCell("A1", { A1: '=MDURATION("1/1/2000", "1/1/2040", A2, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 6.85033],
                ["0.02", 22.93014],
                ...
                expect(evaluateCell("A1", { A1: '=MDURATION("1/1/2000", "1/1/2040", 0.05, A2, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["2", 10.35789],
                ["4", 10.3591],
            ])("variation on 5th argument", (arg, result) => {
                expect(evaluateCell("A1", {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=MDURATION(A2, "12/12/21", 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([["12/11/2012"], ["12/12/2012"]])("parameter 2 must be greater than parameter 1", (arg) => {
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", A2, 0.05, 0.1, 1, 0)', A2: arg })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        });
        test.each([
            ["12/12/2021 23:00", 6.48053],
            ["12/12/2021", 6.48053],
        ])("parameter 2 is truncated", (arg, result) => {
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", A2, 0.05, 0.1, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test("parameter 3 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", -0.1, 0.1, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", 0, 0.1, 1, 0)' })).toBeCloseTo(8.18182, 5);
        });
        test("parameter 4 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", 0.05, -0.1, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", 0.05, 0, 1, 0)' })).toBeCloseTo(7.75862, 5);
        });
        test.each([
            ["0", "#ERROR"],
            ["1", 6.48053],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", 0.05, 0.1, A2, 0)', A2: arg }));
            if (typeof result === "number") {
                expectedValue.toBeCloseTo(result);
            }
            else {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", 0.05, 0.1, A2, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([
            ["-1", "#ERROR"],
            ["0", 6.48053],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", 0.05, 0.1, 1, A2)', A2: arg }));
            if (typeof result === "number") {
                expectedValue.toBeCloseTo(result);
            }
            else {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=MDURATION("12/12/12", "12/12/21", 0.05, 0.1, 1, A2)', A2: arg })).toBeCloseTo(result, 5);
        });
    });
    describe("casting", () => {
        describe("on 1st argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION( , 730, 0.1, 0.5, 1)" })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(A2, 730, 0.1, 0.5, 1)" })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION("0", 730, 0.1, 0.5, 1)' })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(A2, 730, 0.1, 0.5, 1)", A2: '="0"' })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=MDURATION(A2, 730, 0.1, 0.5, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(TRUE, 730, 0.1, 0.5, 1)" })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(FALSE, 730, 0.1, 0.5, 1)" })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(A2, 730, 0.1, 0.5, 1)", A2: "TRUE" })).toBeCloseTo(1.25333, 5);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION(0, "730", 0.1, 0.5, 1)' })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, A2, 0.1, 0.5, 1)", A2: '="730"' })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=MDURATION(0, A2, 0.1, 0.5, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=MDURATION(0, A2, 0.1, 0.5, 1)", A2: "TRUE" })).toBeCloseTo(0, 5);
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730,  , 0.5, 1)" })).toBeCloseTo(1.33333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, A2, 0.5, 1)" })).toBeCloseTo(1.33333, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION(0, 730, "0.1", 0.5, 1)' })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, A2, 0.5, 1)", A2: '="0.1"' })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, A2, 0.5, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, TRUE, 0.5, 1)" })).toBeCloseTo(1.04762, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, FALSE, 0.5, 1)" })).toBeCloseTo(1.33333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, A2, 0.5, 1)", A2: "TRUE" })).toBeCloseTo(1.04762, 5);
            });
        });
        describe("on 4th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, , 1 )" })).toBeCloseTo(1.91667, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, A2, 1)" })).toBeCloseTo(1.91667, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION(0, 730, 0.1, "0.5", 1)' })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, A2, 1)", A2: '="0.5"' })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, A2, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, TRUE, 1)" })).toBeCloseTo(0.92308, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, FALSE, 1)" })).toBeCloseTo(1.91667, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, A2, 1)", A2: "TRUE" })).toBeCloseTo(0.92308, 5);
            });
        });
        describe("on 5th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION(0, 730, 0.1, 0.5, "1")' })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, A2)", A2: '="1"' })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, TRUE)" })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, FALSE)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, A2)", A2: "TRUE" })).toBeCloseTo(1.25333, 5);
            });
        });
        describe("on 6th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, 1,  )" })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, 1, A2)" })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION(0, 730, 0.1, 0.5, 1, "0")' })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, 1, A2)", A2: '="0"' })).toBeCloseTo(1.25333, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=MDURATION(0, 730, 0.1, 0.5, 1, " ")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=MDURATION(0, 730, 0.1, 0.5, 1, "kikou")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, 1, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, 1, TRUE)" })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, 1, FALSE)" })).toBeCloseTo(1.25333, 5);
                expect(evaluateCell("A1", { A1: "=MDURATION(0, 730, 0.1, 0.5, 1, A2)", A2: "TRUE" })).toBeCloseTo(1.25333, 5);
            });
        });
    });
});
describe("NPV formula", () => {
    ...
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=NPV("0.05", 10, 20)' })).toBeCloseTo(27.6644, 5);
                expect(evaluateCell("A1", { A1: "=NPV(A2, 10, 20)", A2: '="0.05"' })).toBeCloseTo(27.6644, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
        ...
        describe("on repeatable argument", () => {
            ...
            test("empty cells are ignored", () => {
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: "" })).toBeCloseTo(27.6644, 5);
            });
            test("strings in cell which which cannot be cast in number are ignored", () => {
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: "20" })).toBeCloseTo(44.94115, 5);
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: "=20" })).toBeCloseTo(44.94115, 5);
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: '="20"' })).toBeCloseTo(27.6644, 5);
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: '"42"' })).toBeCloseTo(27.6644, 5);
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: "coucou" })).toBeCloseTo(27.6644, 5);
            });
            test("booleans in cell are ignored", () => {
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: "TRUE" })).toBeCloseTo(27.6644, 5);
                expect(evaluateCell("A1", { A1: "=NPV(0.05, 10, A2, 20)", A2: "FALSE" })).toBeCloseTo(27.6644, 5);
            });
        });
    });
});
describe("PDURATION formula", () => {
    ...
    describe("business logic", () => {
        describe("return the PDURATION", () => {
            ...
            test.each([
                ...
                expect(evaluateCell("A1", { A1: "=PDURATION(A2, 10, 20)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["30", -8.31039],
                ["4242.42", -109.79994],
            ])("variation on 2nd argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: "=PDURATION(0.05, A2, 20)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["53", 34.18121],
                ["0.02", -127.3742],
            ])("variation on 3th argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: "=PDURATION(0.05, 10, A2)", A2: arg })).toBeCloseTo(result, 5);
            });
        });
    ...
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PDURATION("0.05", 10, 20)' })).toBeCloseTo(14.2067, 5);
                expect(evaluateCell("A1", { A1: "=PDURATION(A2, 10, 20)", A2: '="0.05"' })).toBeCloseTo(14.2067, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
        ...
        describe("on 2nd argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PDURATION(0.05, "10", 20)' })).toBeCloseTo(14.2067, 5);
                expect(evaluateCell("A1", { A1: "=PDURATION(0.05, A2, 20)", A2: '="10"' })).toBeCloseTo(14.2067, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PDURATION(0.05, A2, 20)", A2: "TRUE" })).toBeCloseTo(61.40033, 5);
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PDURATION(0.05, 10, "20")' })).toBeCloseTo(14.2067, 5);
                expect(evaluateCell("A1", { A1: "=PDURATION(0.05, 10, A2)", A2: '="20"' })).toBeCloseTo(14.2067, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=PDURATION(0.05, 10, " ")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PDURATION(0.05, 10, A2)", A2: "TRUE" })).toBeCloseTo(-47.19363, 5);
            });
        });
    });
});
    ...
    describe("business logic", () => {
        describe("return the PV", () => {
            ...
            test.each([
                ...
                expect(evaluateCell("A1", { A1: "=PV(0.05, A2, 3, 70, 0)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["3.9", -73.08869],
                ["0", -42.97393],
                ...
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, A2, 70, 0)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["70.9", -66.69165],
                ["0", -23.1652],
                ...
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, 3, A2, 0)", A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.9", -67.29739],
                ["23", -67.29739],
            ])("variation on 5th argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, 3, 70, A2)", A2: arg })).toBeCloseTo(result, 5);
            });
        });
    });
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PV("0.05", 10, 3, 70, 0)' })).toBeCloseTo(-66.13913, 5);
                expect(evaluateCell("A1", { A1: "=PV(A2, 10, 3, 70, 0)", A2: '="0.05"' })).toBeCloseTo(-66.13913, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PV(A2, 10, 3, 70, 0)", A2: "TRUE" })).toBeCloseTo(-3.06543, 5);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PV(0.05, "10", 3, 70, 0)' })).toBeCloseTo(-66.13913, 5);
                expect(evaluateCell("A1", { A1: "=PV(0.05, A2, 3, 70, 0)", A2: '="10"' })).toBeCloseTo(-66.13913, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PV(0.05, A2, 3, 70, 0)", A2: "TRUE" })).toBeCloseTo(-69.52381, 5);
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PV(0.05, 10, "3", 70, 0)' })).toBeCloseTo(-66.13913, 5);
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, A2, 70, 0)", A2: '="3"' })).toBeCloseTo(-66.13913, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, A2, 70, 0)", A2: "TRUE" })).toBeCloseTo(-50.69566, 5);
            });
        });
        describe("on 4th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PV(0.05, 10, 3, "70", 0)' })).toBeCloseTo(-66.13913, 5);
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, 3, A2, 0)", A2: '="70"' })).toBeCloseTo(-66.13913, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
            ...
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, 3, A2, 0)", A2: "TRUE" })).toBeCloseTo(-23.77912, 5);
            });
        });
        describe("on 5th argument", () => {
            test("empty argument/cell are considered as FALSE", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as boolean", () => {
                expect(evaluateCell("A1", { A1: '=PV(0.05, 10, 3, 70, "TRUE")' })).toBeCloseTo(-67.29739, 5);
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, 3, 70, A2)", A2: '="TRUE"' })).toBeCloseTo(-67.29739, 5);
            });
            test("string/string in cell which cannot be cast in boolean return an error", () => {
            ...
            test("number/number in cell are interpreted as boolean", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PV(0.05, 10, 3, 70, A2)", A2: "42" })).toBeCloseTo(-67.29739, 5);
            });
        });
    });
});
describe("PRICE formula", () => {
    test("take at 6 or 7 arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=PRICE(0, 365, 0.05, 0.1, 120, 1)" })).toBeCloseTo(113.63636, 5);
        expect(evaluateCell("A1", { A1: "=PRICE(0, 365, 0.05, 0.1, 120, 1, 0)" })).toBeCloseTo(113.63636, 5);
        expect(evaluateCell("A1", { A1: "=PRICE(0, 365, 0.05, 0.1, 120, 1, 0, 42)" })).toBe("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
    });
    describe("business logic", () => {
        describe("return the PRICE", () => {
            test("basic formula", () => {
                expect(evaluateCell("A1", { A1: '=PRICE("1/1/2000", "1/1/2040", 0.05, 0.1, 120, 1, 0)' })).toBeCloseTo(51.54664, 5);
            });
            test.each([
                ["01/01/1999", 51.40604],
                ["01/01/2015", 56.46072],
            ])("variation on 1st argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=PRICE(A2, "1/1/2040", 0.05, 0.1, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["01/01/2041", 51.40604],
                ["01/01/2010", 76.98803],
            ])("variation on 2nd argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=PRICE("1/1/2000", A2, 0.05, 0.1, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 149.33715],
                ["0.02", 22.20949],
                ...
                expect(evaluateCell("A1", { A1: '=PRICE("1/1/2000", "1/1/2040", A2, 0.1, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 33.65688],
                ["0.02", 191.12425],
                ...
                expect(evaluateCell("A1", { A1: '=PRICE("1/1/2000", "1/1/2040", 0.05, A2, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["100", 51.10475],
                ["200", 53.31424],
                ...
                expect(evaluateCell("A1", { A1: '=PRICE("1/1/2000", "1/1/2040", 0.05, 0.1, A2, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["2", 51.41239],
                ["4", 51.34673],
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=PRICE(A2, "12/12/21", 0.05, 0.1, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([["12/11/2012"], ["12/12/2012"]])("parameter 2 must be greater than parameter 1", (arg) => {
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", A2, 0.05, 0.1, 120, 1, 0)', A2: arg })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        });
        test.each([
            ["12/12/2021 23:00", 79.68683],
            ["12/12/2021", 79.68683],
        ])("parameter 2 is truncated", (arg, result) => {
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", A2, 0.05, 0.1, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test("parameter 3 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", -0.1, 0.1, 120, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0, 0.1, 120, 1, 0)' })).toBeCloseTo(50.89171, 5);
        });
        test("parameter 4 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, -0.1, 120, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, 0, 120, 1, 0)' })).toBeCloseTo(165, 5);
        });
        test("parameter 5 must be greater than 0", () => {
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, 0.1, 0, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, 0.1, 1, 1, 0)' })).toBeCloseTo(29.21922, 5);
        });
        test.each([
            ["0", "#ERROR"],
            ["1", 79.68683],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, 0.1, 120, A2, 0)', A2: arg }));
            if (typeof result === "number") {
                expectedValue.toBeCloseTo(result);
            }
            else {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, 0.1, 120, A2, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([
            ["-1", "#ERROR"],
            ["0", 79.68683],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, 0.1, 120, 1, A2)', A2: arg }));
            if (typeof result === "number") {
                expectedValue.toBeCloseTo(result);
            }
            else {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=PRICE("12/12/12", "12/12/21", 0.05, 0.1, 120, 1, A2)', A2: arg })).toBeCloseTo(result, 5);
        });
    });
    describe("casting", () => {
        describe("on 1st argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=PRICE( , 730, 0.1, 0.5, 120, 1)" })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(A2, 730, 0.1, 0.5, 120, 1)" })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PRICE("0", 730, 0.1, 0.5, 120, 1)' })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(A2, 730, 0.1, 0.5, 120, 1)", A2: '="0"' })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PRICE(A2, 730, 0.1, 0.5, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(TRUE, 730, 0.1, 0.5, 120, 1)" })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(FALSE, 730, 0.1, 0.5, 120, 1)" })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(A2, 730, 0.1, 0.5, 120, 1)", A2: "TRUE" })).toBeCloseTo(64.44444, 5);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PRICE(0, "730", 0.1, 0.5, 120, 1)' })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, A2, 0.1, 0.5, 120, 1)", A2: '="730"' })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PRICE(0, A2, 0.1, 0.5, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PRICE(0, A2, 0.1, 0.5, 120, 1)", A2: "TRUE" })).toBeCloseTo(120, 5);
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730,  , 0.5, 120, 1)" })).toBeCloseTo(53.33333, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, A2, 0.5, 120, 1)" })).toBeCloseTo(53.33333, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PRICE(0, 730, "0.1", 0.5, 120, 1)' })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, A2, 0.5, 120, 1)", A2: '="0.1"' })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, A2, 0.5, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, TRUE, 0.5, 120, 1)" })).toBeCloseTo(164.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, FALSE, 0.5, 120, 1)" })).toBeCloseTo(53.33333, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, A2, 0.5, 120, 1)", A2: "TRUE" })).toBeCloseTo(164.44444, 5);
            });
        });
        describe("on 4th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PRICE(0, 730, 0.1, "0.5", 120, 1)' })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, A2, 120, 1)", A2: '="0.5"' })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, A2, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, TRUE, 120, 1)" })).toBeCloseTo(37.5, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, FALSE, 120, 1)" })).toBeCloseTo(140.0, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, A2, 120, 1)", A2: "TRUE" })).toBeCloseTo(37.5, 5);
            });
        });
        describe("on 5th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PRICE(0, 730, 0.1, 0.5, "120", 1)' })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, A2, 1)", A2: '="120"' })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, A2, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, TRUE, 1)" })).toBeCloseTo(11.55556, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, FALSE, 1)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, A2, 1)", A2: "TRUE" })).toBeCloseTo(11.55556, 5);
            });
        });
        describe("on 6th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PRICE(0, 730, 0.1, 0.5, 120, "1")' })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, A2)", A2: '="1"' })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, TRUE)" })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, FALSE)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, A2)", A2: "TRUE" })).toBeCloseTo(64.44444, 5);
            });
        });
        describe("on 7th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, 1,  )" })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, 1, A2)" })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=PRICE(0, 730, 0.1, 0.5, 120, 1, "0")' })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, 1, A2)", A2: '="0"' })).toBeCloseTo(64.44444, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=PRICE(0, 730, 0.1, 0.5, 120, 1, " ")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=PRICE(0, 730, 0.1, 0.5, 120, 1, "kikou")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, 1, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, 1, TRUE)" })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, 1, FALSE)" })).toBeCloseTo(64.44444, 5);
                expect(evaluateCell("A1", { A1: "=PRICE(0, 730, 0.1, 0.5, 120, 1, A2)", A2: "TRUE" })).toBeCloseTo(64.44444, 5);
            });
        });
    });
});
describe("YIELD formula", () => {
    test("take at 6 or 7 arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=YIELD(0, 365, 0.05, 90, 120, 1, 0)" })).toBeCloseTo(0.38889, 5);
    ...
    describe("business logic", () => {
        describe("return the YIELD", () => {
            test("basic formula", () => {
                expect(evaluateCell("A1", { A1: '=YIELD("1/1/2000", "1/1/2040", 0.05, 90, 120, 1, 0)' })).toBeCloseTo(0.05783, 5);
            });
            test.each([
                ["01/01/1999", 0.0577],
                ["01/01/2015", 0.0615],
            ])("variation on 1st argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=YIELD(A2, "1/1/2040", 0.05, 90, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["01/01/2041", 0.0577],
                ["01/01/2010", 0.07871],
            ])("variation on 2nd argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=YIELD("1/1/2000", A2, 0.05, 90, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 0.16678],
                ["0.02", 0.02696],
                ...
                expect(evaluateCell("A1", { A1: '=YIELD("1/1/2000", "1/1/2040", A2, 90, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["120", 0.04167],
                ["200", 0.0181],
                ...
                expect(evaluateCell("A1", { A1: '=YIELD("1/1/2000", "1/1/2040", 0.05, A2, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["100", 0.05634],
                ["200", 0.0629],
                ...
                expect(evaluateCell("A1", { A1: '=YIELD("1/1/2000", "1/1/2040", 0.05, 90, A2, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["2", 0.05776],
                ["4", 0.05772],
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=YIELD(A2, "12/12/21", 0.05, 90, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([["12/11/2012"], ["12/12/2012"]])("parameter 2 must be greater than parameter 1", (arg) => {
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", A2, 0.05, 90, 120, 1, 0)', A2: arg })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        });
        test.each([
            ["12/12/2021 23:00", 0.08202],
            ["12/12/2021", 0.08202],
        ])("parameter 2 is truncated", (arg, result) => {
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", A2, 0.05, 90, 120, 1, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test("parameter 3 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", -0.1, 90, 120, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0, 90, 120, 1, 0)' })).toBeCloseTo(0.03248, 5);
        });
        test("parameter 4 must be greater than 0", () => {
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 0, 120, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 1, 120, 1, 0)' })).toBeCloseTo(5.00006, 5);
        });
        test("parameter 5 must be greater than 0", () => {
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 90, 0, 1, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 90, 1, 1, 0)' })).toBeCloseTo(-0.11487, 5);
        });
        test.each([
            ["0", "#ERROR"],
            ["1", 0.08202],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 90, 120, A2, 0)', A2: arg }));
            if (typeof result === "number") {
                expectedValue.toBeCloseTo(result);
            }
            else {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 90, 120, A2, 0)', A2: arg })).toBeCloseTo(result, 5);
        });
        test.each([
            ["-1", "#ERROR"],
            ["0", 0.08202],
            ...
            const expectedValue = expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 90, 120, 1, A2)', A2: arg }));
            if (typeof result === "number") {
                expectedValue.toBeCloseTo(result);
            }
            else {
        ...
        test.each([
            ...
            expect(evaluateCell("A1", { A1: '=YIELD("12/12/12", "12/12/21", 0.05, 90, 120, 1, A2)', A2: arg })).toBeCloseTo(result, 5);
        });
    });
    describe("casting", () => {
        describe("on 1st argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=YIELD( , 730, 0.1, 90, 120, 1)" })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(A2, 730, 0.1, 90, 120, 1)" })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELD("0", 730, 0.1, 90, 120, 1)' })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(A2, 730, 0.1, 90, 120, 1)", A2: '="0"' })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELD(A2, 730, 0.1, 90, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELD(TRUE, 730, 0.1, 90, 120, 1)" })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(FALSE, 730, 0.1, 90, 120, 1)" })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(A2, 730, 0.1, 90, 120, 1)", A2: "TRUE" })).toBeCloseTo(0.25869, 5);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELD(0, "730", 0.1, 90, 120, 1)' })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, A2, 0.1, 90, 120, 1)", A2: '="730"' })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELD(0, A2, 0.1, 90, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELD(0, A2, 0.1, 90, 120, 1)", A2: "TRUE" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!;
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELD(0, 730, "0.1", 90, 120, 1)' })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, A2, 90, 120, 1)", A2: '="0.1"' })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, A2, 90, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, TRUE, 90, 120, 1)" })).toBeCloseTo(1.2148, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, FALSE, 90, 120, 1)" })).toBeCloseTo(0.1547, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, A2, 90, 120, 1)", A2: "TRUE" })).toBeCloseTo(1.2148, 5);
            });
        });
        describe("on 4th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELD(0, 730, 0.1, "90", 120, 1)' })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, A2, 120, 1)", A2: '="90"' })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, A2, 120, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, TRUE, 120, 1)" })).toBeCloseTo(-8.4499, 5); // @compatibility: on google sheets return 16.4499
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, FALSE, 120, 1)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, A2, 120, 1)", A2: "TRUE" })).toBeCloseTo(-8.4499, 5); // @compatibility: on google sheets return 16.4499
            });
        });
        describe("on 5th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELD(0, 730, 0.1, 90, "120", 1)' })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, A2, 1)", A2: '="120"' })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, A2, 1)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, TRUE, 1)" })).toBeCloseTo(-0.59045, 5); // @compatibility: on google sheets return -1.29843
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, FALSE, 1)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, A2, 1)", A2: "TRUE" })).toBeCloseTo(-0.59045, 5); // @compatibility: on google sheets return -1.29843
            });
        });
        describe("on 6th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELD(0, 730, 0.1, 90, 120, "1")' })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, A2)", A2: '="1"' })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, TRUE)" })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, FALSE)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, A2)", A2: "TRUE" })).toBeCloseTo(0.25869, 5);
            });
        });
        describe("on 7th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, 1,  )" })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, 1, A2)" })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELD(0, 730, 0.1, 90, 120, 1, "0")' })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, 1, A2)", A2: '="0"' })).toBeCloseTo(0.25869, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=YIELD(0, 730, 0.1, 90, 120, 1, " ")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=YIELD(0, 730, 0.1, 90, 120, 1, "kikou")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, 1, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, 1, TRUE)" })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, 1, FALSE)" })).toBeCloseTo(0.25869, 5);
                expect(evaluateCell("A1", { A1: "=YIELD(0, 730, 0.1, 90, 120, 1, A2)", A2: "TRUE" })).toBeCloseTo(0.25869, 5);
            });
        });
    });
});
describe("YIELDMAT formula", () => {
    test("take at 6 or 7 arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.05, 150)" })).toBeCloseTo(-0.29727, 5);
        expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.05, 150, 0)" })).toBeCloseTo(-0.29727, 5);
        expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.05, 150, 0, 42)" })).toBe("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
    });
    describe("business logic", () => {
        describe("return the YIELDMAT", () => {
            test("basic formula", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/1/2040", "1/1/2000", 0.05, 120, 0)' })).toBeCloseTo(0.02549, 5);
            });
            test.each([
                ["03/03/2003", 0.03281],
                ["06/06/2006", 0.02895],
            ...
            test.each([
                ...
                expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", A2, "1/1/2000", 0.05, 120, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["05/05/2005", 0.03024],
                ["06/06/2006", 0.03144],
            ])("variation on 3th argument", (arg, result) => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/1/2040", A2, 0.05, 120, 0)', A2: arg })).toBeCloseTo(result, 5);
            });
            test.each([
                ["0.15", 0.05309],
                ["0.02", 0.00952],
        ...
        test("parameter 1 must be greater than or equal parameter 3", () => {
            expect(evaluateCell("A1", { A1: '=YIELDMAT("12/31/1999", "1/1/2040", "1/1/2000", 0.05, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2000", "1/1/2040", "1/1/2000", 0.05, 120, 0)' })).toBeCloseTo(0.0375, 5);
        });
        ...
        test("parameter 2 must be greater than parameter 1", () => {
            expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/1/2010", "1/1/2000", 0.05, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/2/2010", "1/1/2000", 0.05, 120, 0)' })).toBeCloseTo(-42.32353, 5);
        });
        ...
        test("parameter 4 must be greater than or equal 0", () => {
            expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/1/2040", "1/1/2000", -0.1, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/1/2040", "1/1/2000", 0, 120, 0)' })).toBeCloseTo(-0.00556, 5);
        });
        test("parameter 5 must be greater than 0", () => {
            expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/1/2040", "1/1/2000", 0.05, 0, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: '=YIELDMAT("1/1/2010", "1/1/2040", "1/1/2000", 0.05, 1, 0)' })).toBeCloseTo(0.16275, 5);
        });
        test.each([
            ["-1", "#ERROR"],
            ["0", 0.02549],
            ...
            const expectedValue = expect(evaluateCell("A1", {
                A1: '=YIELDMAT("1/1/2010", "1/1/2040", "1/1/2000", 0.05, 120, A2)',
                A2: arg,
            }));
            if (typeof result === "number") {
    ...
    describe("casting", () => {
        describe("on 1st argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(, 465, 0, 0.25, 120, 0)" })).toBeCloseTo(0.07761, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(A2, 465, 0, 0.25, 120, 0)" })).toBeCloseTo(0.07761, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT("100", 465, 0, 0.25, 120, 0)' })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(A2, 465, 0, 0.25, 120, 0)", A2: '="100"' })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(" ", 465, 0, 0.25, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=YIELDMAT("kikou", 465, 0, 0.25, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELDMAT(A2, 465, 0, 0.25, 120, 0)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(TRUE, 465, 0, 0.25, 120, 0)" })).toBeCloseTo(0.07761, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(FALSE, 465, 0, 0.25, 120, 0)" })).toBeCloseTo(0.07761, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(A2, 465, 0, 0.25, 120, 0)", A2: "TRUE" })).toBeCloseTo(0.07761, 5);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, "465", 0, 0.25, 120, 0)' })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, A2, 0, 0.25, 120, 0)", A2: '="465"' })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, " ", 0, 0.25, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, "kikou", 0, 0.25, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, A2, 0, 0.25, 120, 0)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                ...
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, A2, 0, 0.25, 120, 0)", A2: "TRUE" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!;
            });
        });
        describe("on 3th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465,  , 0.25, 120, 0)" })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, A2, 0.25, 120, 0)" })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, "0", 0.25, 120, 0)' })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, A2, 0.25, 120, 0)", A2: '="0"' })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, " ", 0.25, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, "kikou", 0.25, 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, A2, 0.25, 120, 0)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, TRUE, 0.25, 120, 0)" })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, FALSE, 0.25, 120, 0)" })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, A2, 0.25, 120, 0)", A2: "TRUE" })).toBeCloseTo(0.03941, 5);
            });
        });
        describe("on 4th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, , 120, 0)" })).toBeCloseTo(-0.16667, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, A2, 120, 0)" })).toBeCloseTo(-0.16667, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, "0.25", 120, 0)' })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, A2, 120, 0)", A2: '="0.25"' })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, " ", 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, "kikou", 120, 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, A2, 120, 0)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, TRUE, 120, 0)" })).toBeCloseTo(0.54237, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, FALSE, 120, 0)" })).toBeCloseTo(-0.16667, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, A2, 120, 0)", A2: "TRUE" })).toBeCloseTo(0.54237, 5);
            });
        });
        describe("on 5th argument", () => {
            test("empty argument/cell are considered as 0", () => {
            ...
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, 0.25, "120", 0)' })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, A2, 0)", A2: '="120"' })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, 0.25, " ", 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, 0.25, "kikou", 0)' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, A2, 0)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, TRUE, 0)" })).toBeCloseTo(15.74603, 5); // @compatibility: on google sheets return -1.29843
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, FALSE, 0)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, A2, 0)", A2: "TRUE" })).toBeCloseTo(15.74603, 5);
            });
        });
        describe("on 6th argument", () => {
            test("empty argument/cell are considered as 0", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, 120,  )" })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, 120, A2)" })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, 0.25, 120, "0")' })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, 120, A2)", A2: '="0"' })).toBeCloseTo(0.03941, 5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, 0.25, 120, " ")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: '=YIELDMAT(100, 465, 0, 0.25, 120, "kikou")' })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, 120, A2)", A2: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, 120, TRUE)" })).toBeCloseTo(0.03942, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, 120, FALSE)" })).toBeCloseTo(0.03941, 5);
                expect(evaluateCell("A1", { A1: "=YIELDMAT(100, 465, 0, 0.25, 120, A2)", A2: "TRUE" })).toBeCloseTo(0.03942, 5);
            });
        });
    });
});
//# sourceMappingURL=module_financial_test.js.map