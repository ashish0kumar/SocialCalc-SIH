    ...
    describe("business logic", () => {
        describe("return the YEARFRAC with convention 0", () => {
            ...
            describe("if start dates are the last day of february", () => {
                ...
                ])("end dates in last days of february are replaced by 30 (no leap year / no leap year)", (d1, d2, result) => {
                    const grid = { A1: "=YEARFRAC(A2, A3, A4)", A2: d1, A3: d2, A4: conv };
                    expect(evaluateCell("A1", grid)).toBeCloseTo(result, 5);
                });
                test.each([
                ...
                ])("end dates in last days of february are replaced by 30 (no leap year / leap year)", (d1, d2, result) => {
                    const grid = { A1: "=YEARFRAC(A2, A3, A4)", A2: d1, A3: d2, A4: conv };
                    expect(evaluateCell("A1", grid)).toBeCloseTo(result, 5);
                });
                test.each([
                ...
                ])("end dates in last days of february are replaced by 30 (leap year / no leap year)", (d1, d2, result) => {
                    const grid = { A1: "=YEARFRAC(A2, A3, A4)", A2: d1, A3: d2, A4: conv };
                    expect(evaluateCell("A1", grid)).toBeCloseTo(result, 5);
                });
                test.each([
                ...
                ])("end dates in last days of february are replaced by 30 (leap year / leap year)", (d1, d2, result) => {
                    const grid = { A1: "=YEARFRAC(A2, A3, A4)", A2: d1, A3: d2, A4: conv };
                    expect(evaluateCell("A1", grid)).toBeCloseTo(result, 5);
                });
            });
        ...
        describe("return the YEARFRAC with convention 1", () => {
            ...
            ])("case: dates are different by less than a year (sitting on same years)", (d1, d2, result) => {
                const grid = { A1: "=YEARFRAC(A2, A3, A4)", A2: d1, A3: d2, A4: conv };
                expect(evaluateCell("A1", grid)).toBeCloseTo(result, 5);
            });
            test.each([
                // normal year / normal year
                ["3/9/2005", "2/9/2007", 1.92329],
                // normal year / leap year (29 Feb include)
                ["4/9/2005", "3/9/2008", 2.91581],
                // normal year / leap year (29 Feb on limit)
                ["3/29/2005", "2/29/2008", 2.92129],
                // normal year / leap year (29 Feb not include)
                ["3/9/2005", "2/9/2008", 2.92129],
                // leap year / normal year (29 Feb include)
                ["2/9/2004", "1/9/2007", 2.91581],
                // leap year / normal year (29 Feb on limit)
                ["2/29/2004", "1/29/2007", 2.91581],
                // leap year / normal year (29 Feb not include)
                ["3/9/2004", "2/9/2007", 2.92129],
                // leap year / leap year (29 Feb include)
                ["2/9/2004", "3/9/2008", 4.07772],
                ["3/9/2004", "3/9/2008", 3.99836],
                ["2/9/2004", "2/9/2008", 3.99836],
                // leap year / leap year (29 Feb on limit)
                ["1/29/2004", "2/29/2008", 4.0832],
                ["2/29/2004", "2/29/2008", 3.99836],
                ["3/29/2004", "2/29/2008", 3.91899],
                ["2/29/2004", "1/29/2008", 3.91352],
                ["2/29/2004", "3/29/2008", 4.07772],
        ...
        test("parameter 1 must be greater than or equal to 0", () => {
            ...
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "12/30/1899", A3: "12/30/1900" })).toBeCloseTo(1, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "12/29/1899", A3: "12/29/1900" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        });
        test("parameter 1 is truncated", () => {
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "6/6/2006", A3: "6/6/2007" })).toBeCloseTo(1, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "6/6/2006 23:00", A3: "6/6/2007" })).toBeCloseTo(1, 5);
        });
        ...
        test("parameter 2 is truncated", () => {
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "6/6/2006", A3: "6/6/2007" })).toBeCloseTo(1, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "6/6/2006", A3: "6/6/2007 23:00" })).toBeCloseTo(1, 5);
        });
        test("inverting parameters 1 and 2 gives the same result", () => {
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "2/29/2004", A3: "11/12/2013" })).toBeCloseTo(9.7, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "11/12/2013", A3: "2/29/2004" })).toBeCloseTo(9.7, 5);
        });
        test("parameter 3 must be between 0 and 4 inclusive", () => {
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3, -1)", A2: "6/6/2006", A3: "6/6/2007" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3, 0)", A2: "6/6/2006", A3: "6/6/2007" })).toBeCloseTo(1, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3, 4)", A2: "6/6/2006", A3: "6/6/2007" })).toBeCloseTo(1, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3, 5)", A2: "6/6/2006", A3: "6/6/2007" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        });
        test("parameter 3 is truncated", () => {
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3, 2)", A2: "6/6/2006", A3: "3/6/2007" })).toBeCloseTo(0.75833, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3, 2.9)", A2: "6/6/2006", A3: "3/6/2007" })).toBeCloseTo(0.75833, 5);
        });
        test("parameter 3 default value is 0", () => {
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3)", A2: "6/6/2006", A3: "12/12/2012" })).toBeCloseTo(6.51667, 5);
            expect(evaluateCell("A1", { A1: "=YEARFRAC(A2, A3, 0)", A2: "6/6/2006", A3: "12/12/2012" })).toBeCloseTo(6.51667, 5);
        });
    });
    describe("casting", () => {
...
//# sourceMappingURL=module_date.test.js.map