...
describe("AVEDEV formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=AVEDEV(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBe(396.5);
    });
...
describe("AVERAGE formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=average(A2, A3)", A2: "TRUE", A3: "FALSE" })).toEqual("#ERROR"); // @compatibility: on google sheets, return #DIV/0!
        expect(evaluateCell("A1", { A1: "=average(A2, A3)", A2: "TRUE", A3: "42" })).toBe(42);
        expect(evaluateCell("A1", { A1: "=average(A2, A3)", A2: "08/08/2008", A3: "10/10/2010" })).toBe(40064.5);
    });
    test("functional tests on range arguments", () => {
        const grid = {
            A1: "=average(B2:D4)",
...
describe("AVERAGE.WEIGHTED formula", () => {
    ...
    test("casting tests on simple arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: '=average.weighted("@#%!*", "@#%!*", "20", "2")' })).toEqual("#ERROR"); // @compatibility: on google sheets, return #VALUE!
    });
    test("functional tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=average.weighted(A2, A3)", A2: "", A3: "" })).toEqual("#ERROR"); // @compatibility: on google sheets, return #DIV/0!
        expect(evaluateCell("A1", { A1: "=average.weighted(A2, A3)", A2: "0", A3: "0" })).toEqual("#ERROR"); // @compatibility: on google sheets, return #DIV/0!
        expect(evaluateCell("A1", { A1: "=average.weighted(A2, A3)", A2: "0", A3: "1" })).toBe(0);
        expect(evaluateCell("A1", { A1: "=average.weighted(A2, A3, A4)", A2: "1", A3: "1", A4: "3" })).toEqual("#BAD_EXPR"); // @compatibility: on google sheets, return #N/A
...
describe("LARGE formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "", A3: "", A4: "", A5: "0" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "", A3: "", A4: "", A5: "1" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "3", A3: "1", A4: "2", A5: "1" })).toBe(3);
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "3", A3: "1", A4: "2", A5: "2" })).toBe(2);
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "3", A3: "-11", A4: "2", A5: "3" })).toBe(-11);
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "3", A3: "1", A4: "2", A5: "4" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "3", A3: "", A4: "2", A5: "3" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
    });
    test("casting tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: '"3"', A3: "", A4: "2", A5: "1" })).toBe(2);
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: '"3"', A3: "", A4: "", A5: "1" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: '="3"', A3: "", A4: "2", A5: "1" })).toBe(2);
        expect(evaluateCell("A1", {
            A1: "=LARGE(A2:A4, A5)",
            A2: "lol",
        ...
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: '"3"', A3: '"1"', A4: '"2"', A5: "1" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=LARGE(A2:A4, A5)", A2: "TRUE", A3: "0", A4: "0", A5: "1" })).toBe(0);
    });
});
...
describe("MAXA formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=MAXA(A2, A3, A4)", A2: "-1.5", A3: "-10", A4: "Jean Terre" })).toBe(0);
        ...
        expect(evaluateCell("A1", { A1: "=MAXA(A2, A3)", A2: "  ", A3: '=" "' })).toBe(0);
        expect(evaluateCell("A1", { A1: "=MAXA(A2, A3)", A2: " ", A3: '="  "' })).toBe(0);
        expect(evaluateCell("A1", { A1: "=MAXA(A2, A3)", A2: "10/10/2010", A3: "8/8/2008" })).toBe(40461);
...
describe("MINA formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=MINA(A2, A3, A4)", A2: "1.5", A3: "10", A4: "Jean Terre" })).toBe(0);
        ...
        expect(evaluateCell("A1", { A1: "=MINA(A2, A3)", A2: "=42", A3: '="24"' })).toBe(0);
        expect(evaluateCell("A1", { A1: "=MINA(A2, A3)", A2: '="42"', A3: '="24"' })).toBe(0);
        expect(evaluateCell("A1", { A1: "=MINA(A2, A3)", A2: "10/10/2010", A3: "8/8/2008" })).toBe(39668);
    });
    test("functional tests on simple and cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=MINA(A2,)", A2: "" })).toBe(0);
        expect(evaluateCell("A1", { A1: "=MINA(A2,)", A2: " " })).toBe(0);
...
describe.each([["PERCENTILE"], ["PERCENTILE.INC"], ["PERCENTILE.EXC"]])("%s formula", (percentile) => {
    ...
    describe("business logic", () => {
        if (percentile === "=PERCENTILE.EXC") {
            ...
            test("data order does not matter", () => {
                ...
                expect(evaluateCell("A1", { A1: percentile + "(A2:A6, 0.75)", ...unsortedData })).toBe(12);
            });
    ...
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("argument/cell/cell(s) in range that are not numbers are ignored", () => {
                ...
                expect(evaluateCell("A1", { A1: percentile + "(A2:A4, 0.5)", A2: "42", A3: "6", A4: "8" })).toBe(8);
                expect(evaluateCell("A1", { A1: percentile + "(A2:A4, 0.5)", A2: '"42"', A3: "6", A4: "8" })).toBe(7);
                expect(evaluateCell("A1", { A1: percentile + "(A2:A4, 0.5)", A2: "coucou", A3: "6", A4: "8" })).toBe(7);
                expect(evaluateCell("A1", { A1: percentile + "(A2:A4, 0.5)", A2: "TRUE", A3: "6", A4: "8" })).toBe(7);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
                if (percentile === "=PERCENTILE.EXC") {
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, )", A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, A4)", A2: "-12", A3: "-9" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                }
                else {
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, )", A2: "6", A3: "7" })).toBe(6);
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, A4)", A2: "-12", A3: "-9" })).toBe(-12);
                }
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: percentile + '(A2:A3, "0.5")', A2: "6", A3: "7" })).toBe(6.5);
                expect(evaluateCell("A1", { A1: percentile + "(A2:A3, A4)", A2: "6", A3: "7", A4: '="0.5"' })).toBe(6.5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: percentile + '(A2:A3, " ")', A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: percentile + '(A2:A3, "kikou")', A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: percentile + "(A2:A3, A4)", A2: "6", A3: "7", A4: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                if (percentile === "=PERCENTILE.EXC") {
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, TRUE)", A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, FALSE)", A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, A4)", A2: "6", A3: "7", A4: "TRUE" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                }
                else {
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, TRUE)", A2: "6", A3: "7" })).toBe(7);
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, FALSE)", A2: "6", A3: "7" })).toBe(6);
                    expect(evaluateCell("A1", { A1: percentile + "(A2:A3, A4)", A2: "6", A3: "7", A4: "TRUE" })).toBe(7);
                }
            });
        });
    });
    ...
    describe("casting", () => {
        describe("on 1st argument", () => {
            ...
            test("argument/cell/cell(s) in range that are not numbers are ignored", () => {
                ...
                expect(evaluateCell("A1", { A1: quartile + "(A2:A4, 2)", A2: "42", A3: "6", A4: "8" })).toBe(8);
                expect(evaluateCell("A1", { A1: quartile + "(A2:A4, 2)", A2: '"42"', A3: "6", A4: "8" })).toBe(7);
                expect(evaluateCell("A1", { A1: quartile + "(A2:A4, 2)", A2: "coucou", A3: "6", A4: "8" })).toBe(7);
                expect(evaluateCell("A1", { A1: quartile + "(A2:A4, 2)", A2: "TRUE", A3: "6", A4: "8" })).toBe(7);
            });
        });
        describe("on 2nd argument", () => {
            test("empty argument/cell are considered as 0", () => {
                if (quartile === "=QUARTILE.EXC") {
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, )", A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, A4)", A2: "-12", A3: "-9" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                }
                else {
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, )", A2: "6", A3: "7" })).toBe(6);
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, A4)", A2: "-12", A3: "-9" })).toBe(-12);
                }
            });
            test("string/string in cell which can be cast in number are interpreted as numbers", () => {
                expect(evaluateCell("A1", { A1: quartile + '(A2:A3, "2")', A2: "6", A3: "7" })).toBe(6.5);
                expect(evaluateCell("A1", { A1: quartile + "(A2:A3, A4)", A2: "6", A3: "7", A4: '="2"' })).toBe(6.5);
            });
            test("string/string in cell which cannot be cast in number return an error", () => {
                expect(evaluateCell("A1", { A1: quartile + '(A2:A3, " ")', A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: quartile + '(A2:A3, "kikou")', A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                expect(evaluateCell("A1", { A1: quartile + "(A2:A3, A4)", A2: "6", A3: "7", A4: "coucou" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
            });
            test("boolean/boolean in cell are interpreted as numbers", () => {
                if (quartile === "=QUARTILE.EXC") {
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, TRUE)", A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, FALSE)", A2: "6", A3: "7" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, A4)", A2: "6", A3: "7", A4: "TRUE" })).toBe("#ERROR"); // @compatibility: on google sheets, return #VALUE!
                }
                else {
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, TRUE)", A2: "6", A3: "7" })).toBe(6.25);
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, FALSE)", A2: "6", A3: "7" })).toBe(6);
                    expect(evaluateCell("A1", { A1: quartile + "(A2:A3, A4)", A2: "6", A3: "7", A4: "TRUE" })).toBe(6.25);
                }
            });
        });
    });
...
describe("SMALL formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "", A3: "", A4: "", A5: "0" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "", A3: "", A4: "", A5: "1" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "3", A3: "1", A4: "2", A5: "1" })).toBe(1);
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "3", A3: "1", A4: "-42", A5: "1" })).toBe(-42);
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "3", A3: "1", A4: "2", A5: "2" })).toBe(2);
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "3", A3: "1", A4: "2", A5: "4" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "3", A3: "", A4: "2", A5: "3" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
    });
    test("casting tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: '"3"', A3: "", A4: "2", A5: "1" })).toBe(2);
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: '"3"', A3: "", A4: "", A5: "1" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: '="3"', A3: "", A4: "2", A5: "1" })).toBe(2);
        expect(evaluateCell("A1", {
            A1: "=SMALL(A2:A4, A5)",
            A2: "lol",
        ...
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: '"3"', A3: '"1"', A4: '"2"', A5: "1" })).toBe("#ERROR"); // @compatibility: on google sheets, return #NUM!
        expect(evaluateCell("A1", { A1: "=SMALL(A2:A4, A5)", A2: "TRUE", A3: "0", A4: "0", A5: "1" })).toBe(0);
    });
});
describe("STDEV formula", () => {
    ...
    test("casting tests on simple arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: '=STDEV("8/8/2008", "10/10/2010")' })).toBeCloseTo(560.73568, 5);
    });
    test("functional tests on cell arguments", () => {
    ...
    test("casting tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=STDEV(A2, A3, A4)", A2: "2", A3: "4", A4: '="6"' })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV(A2, A3, A4)", A2: "TRUE", A3: "3", A4: "5" })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV(A2, A3, A4)", A2: "test", A3: "3", A4: "5" })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV(A2, A3, A4)", A2: "2", A3: "4", A4: '=""' })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBeCloseTo(560.73568, 5);
    });
});
describe("STDEV.P formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3, A4)", A2: "2", A3: "5", A4: "8" })).toBeCloseTo(2.45);
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3, A4)", A2: "2", A3: "4" })).toBe(1);
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3, A4)", A2: "-3", A3: "0", A4: "3" })).toBeCloseTo(2.45);
    });
    test("casting tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3, A4)", A2: "2", A3: "4", A4: '="6"' })).toBe(1);
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3, A4)", A2: "TRUE", A3: "3", A4: "5" })).toBe(1);
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3, A4)", A2: "test", A3: "3", A4: "5" })).toBe(1);
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3, A4)", A2: "2", A3: "4", A4: '=""' })).toBe(1);
        expect(evaluateCell("A1", { A1: "=STDEV.P(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBe(396.5);
    });
});
describe("STDEV.S formula", () => {
    ...
    test("casting tests on simple arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: '=STDEV.S("8/8/2008", "10/10/2010")' })).toBeCloseTo(560.73568, 5);
    });
    test("functional tests on cell arguments", () => {
    ...
    test("casting tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=STDEV.S(A2, A3, A4)", A2: "2", A3: "4", A4: '="6"' })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV.S(A2, A3, A4)", A2: "TRUE", A3: "3", A4: "5" })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV.S(A2, A3, A4)", A2: "test", A3: "3", A4: "5" })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV.S(A2, A3, A4)", A2: "2", A3: "4", A4: '=""' })).toBeCloseTo(1.41);
        expect(evaluateCell("A1", { A1: "=STDEV.S(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBeCloseTo(560.73568, 5);
    });
});
describe("STDEVA formula", () => {
    ...
    test("casting tests on simple arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: '=STDEVA("8/8/2008", "10/10/2010")' })).toBeCloseTo(560.73568, 5);
    });
    test("functional tests on cell arguments", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=STDEVA(A2, A3, A4)", A2: "test", A3: "3", A4: "5" })).toBeCloseTo(2.52);
        expect(evaluateCell("A1", { A1: "=STDEVA(A2, A3, A4)", A2: "2", A3: "4", A4: '=""' })).toBe(2);
        expect(evaluateCell("A1", { A1: "=STDEVA(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBeCloseTo(560.73568, 5);
    });
});
describe("STDEVP formula", () => {
    ...
    test("functional tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=STDEVP(A2, A3, A4)", A2: "2", A3: "5", A4: "8" })).toBeCloseTo(2.45);
        expect(evaluateCell("A1", { A1: "=STDEVP(A2, A3, A4)", A2: "2", A3: "4" })).toBe(1);
        expect(evaluateCell("A1", { A1: "=STDEVP(A2, A3, A4)", A2: "-3", A3: "0", A4: "3" })).toBeCloseTo(2.45);
    });
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=STDEVP(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBe(396.5);
    });
});
describe("STDEVPA formula", () => {
    ...
    test("Sfunctional tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3, A4)", A2: "2", A3: "5", A4: "8" })).toBeCloseTo(2.45);
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3, A4)", A2: "2", A3: "4" })).toBe(1);
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3, A4)", A2: "-3", A3: "0", A4: "3" })).toBeCloseTo(2.45);
    });
    test("Scasting tests on cell arguments", () => {
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3, A4)", A2: "3", A3: "6", A4: '="9"' })).toBeCloseTo(2.45);
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3, A4)", A2: "TRUE", A3: "4", A4: "7" })).toBeCloseTo(2.45);
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3, A4)", A2: "test", A3: "3", A4: "6" })).toBeCloseTo(2.45);
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3, A4)", A2: "3", A3: "6", A4: '=""' })).toBeCloseTo(2.45);
        expect(evaluateCell("A1", { A1: "=STDEVPA(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBe(396.5);
    });
});
describe("VAR formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=VAR(A2, A3)", A2: "8/8/2008", A3: "10/10/2010" })).toBe(314424.5);
    });
});
describe("VAR.P formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=VAR.P(A2, A3, A4)", A2: "1/11/1900", A3: "1/8/1900", A4: "FALSE" })).toBe(2.25);
    });
});
describe("VAR.S formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=VAR.S(A2, A3, A4)", A2: "1/11/1900", A3: "1/8/1900", A4: "FALSE" })).toBe(4.5);
    });
});
describe("VARA formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=VARA(A2, A3, A4)", A2: "1/11/1900", A3: "1/8/1900", A4: "test" })).toBe(39);
    });
});
...
describe("VARPA formula", () => {
    ...
    test("casting tests on cell arguments", () => {
        ...
        expect(evaluateCell("A1", { A1: "=VARPA(A2, A3, A4)", A2: "1/11/1900", A3: "1/8/1900", A4: "test" })).toBe(26);
    });
});
//# sourceMappingURL=module_statistical.test.js.map