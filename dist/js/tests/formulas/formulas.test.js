...
function moveFormula(model, formula, offsetX, offsetY) {
    const sheetId = model.getters.getActiveSheetId();
    const createCell = cellFactory(model.getters);
    const cell = createCell("cellId", formula, {}, sheetId);
    const newDependencies = model.getters.createAdaptedRanges(cell.dependencies, offsetX, offsetY, sheetId);
