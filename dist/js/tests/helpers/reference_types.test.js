...
function refToken(referenceString) {
...
describe("loopThroughReferenceType", () => {
    ...
    test("can have sheet reference on range", () => {
        expect(loopThroughReferenceType(refToken("Sheet2!A1:B1"))).toEqual(refToken("Sheet2!$A$1:$B$1"));
        expect(loopThroughReferenceType(refToken("Sheet2!$A$1:$B$1"))).toEqual(refToken("Sheet2!A$1:B$1"));
        expect(loopThroughReferenceType(refToken("Sheet2!A$1:B$1"))).toEqual(refToken("Sheet2!$A1:$B1"));
        expect(loopThroughReferenceType(refToken("Sheet2!$A1:$B1"))).toEqual(refToken("Sheet2!A1:B1"));
    });
});
//# sourceMappingURL=reference_types.test.js.map